...
#if !defined(ARCADIA_PIXELBUFFERIO_WINDOWS_PNGIMAGEWRITER_H_INCLUDED)
#define ARCADIA_PIXELBUFFERIO_WINDOWS_PNGIMAGEWRITER_H_INCLUDED
...
#endif // ARCADIA_PIXELBUFFERIO_WINDOWS_PNGIMAGEWRITER_H_INCLUDED
