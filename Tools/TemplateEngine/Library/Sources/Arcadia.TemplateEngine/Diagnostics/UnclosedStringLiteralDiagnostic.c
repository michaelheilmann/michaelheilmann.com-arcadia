...
#define ARCADIA_TEMPLATENGINE_PRIVATE (1)
...
constructImpl
  (
    ...
    Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnosticDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.TemplateEngine.Diagnostics.UnexpectedSymbolDiagnostic", Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic,
...
{
  Arcadia_EnterConstructor(Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic);
  ...
  Arcadia_LeaveConstructor(Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic);
}
...
{ 
  _Arcadia_BeginCreate(Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic);
  ...
  Arcadia_ValueStack_pushEnumerationValue(thread, Arcadia_EnumerationValue_make(_Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnosticContext_getType(thread), context));
  Arcadia_ValueStack_pushNatural8Value(thread, 2);
  _Arcadia_EndCreate(Arcadia_TemplateEngine_Diagnostics_UnclosedStringLiteralDiagnostic);
}
