...
#if !defined(ARCADIA_TEMPLATEENGINE_DIRECTIVES_WORDTYPE_H_INCLUDED)
#define ARCADIA_TEMPLATEENGINE_DIRECTIVES_WORDTYPE_H_INCLUDED
...
#endif // ARCADIA_TEMPLATEENGINE_DIRECTIVES_WORDTYPE_H_INCLUDED
