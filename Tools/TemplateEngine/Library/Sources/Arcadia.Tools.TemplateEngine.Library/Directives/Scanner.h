...
#if !defined(ARCADIA_TEMPLATEENGINE_DIRECTIVES_SCANNER_H_INCLUDED)
#define ARCADIA_TEMPLATEENGINE_DIRECTIVES_SCANNER_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.TemplateEngine.Directives.Scanner", Directives_Scanner,
                          u8"Arcadia.Languages.Scanner");

struct Directives_ScannerDispatch {
  Arcadia_Languages_ScannerDispatch _parent;
};

struct Directives_Scanner {
...
#endif // ARCADIA_TEMPLATEENGINE_DIRECTIVES_SCANNER_H_INCLUDED
