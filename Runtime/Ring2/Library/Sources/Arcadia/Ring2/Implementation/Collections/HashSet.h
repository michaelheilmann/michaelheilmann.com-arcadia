...
#if !defined(ARCADIA_RING2_IMPLEMENTATION_HASHSET_H_INCLUDED)
#define ARCADIA_RING2_IMPLEMENTATION_HASHSET_H_INCLUDED
...
#endif // ARCADIA_RING2_IMPLEMENTATION_HASHSET_H_INCLUDED
