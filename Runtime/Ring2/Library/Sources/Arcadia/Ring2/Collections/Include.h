...
#if !defined(ARCADIA_RING2_COLLECTIONS_INCLUDE_H_INCLUDED)
#define ARCADIA_RING2_COLLECTIONS_INCLUDE_H_INCLUDED
...
#endif // ARCADIA_RING2_COLLECTIONS_INCLUDE_H_INCLUDED
