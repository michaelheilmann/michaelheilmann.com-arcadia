...
#if !defined(ARCADIA_RING2_COLLECTIONS_STACK_H_INCLUDED)
#define ARCADIA_RING2_COLLECTIONS_STACK_H_INCLUDED
...
// https://michaelheilmann.com/Arcadia/Ring2/#Arcadia_Stack_peekAt
Arcadia_Value
