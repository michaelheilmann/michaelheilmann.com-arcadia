...
#if !defined(ARCADIA_RING2_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED)
#define ARCADIA_RING2_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED
...
// @brief Get the home folder under Linux.
...
#endif // ARCADIA_RING2_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED
