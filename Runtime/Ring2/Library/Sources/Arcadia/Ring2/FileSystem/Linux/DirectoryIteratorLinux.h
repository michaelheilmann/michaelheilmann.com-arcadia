...
#if !defined(ARCADIA_RING2_FILESYSTEM_LINUX_DIRECTORYITERATORLINUX_H_INCLUDED)
#define ARCADIA_RING2_FILESYSTEM_LINUX_DIRECTORYITERATORLINUX_H_INCLUDED
...
#endif // ARCADIA_RING2_FILESYSTEM_LINUX_DIRECTORYITERATORLINUX_H_INCLUDED
