...
#if !defined(ARCADIA_RING2_FILESYSTEM_INCLUDE_H_INCLUDED)
#define ARCADIA_RING2_FILESYSTEM_INCLUDE_H_INCLUDED
...
#include "Arcadia/Ring2/FileSystem/NonExistingFilePolicy.h"

#endif // ARCADIA_RING2_FILESYSTEM_INCLUDE_H_INCLUDED
