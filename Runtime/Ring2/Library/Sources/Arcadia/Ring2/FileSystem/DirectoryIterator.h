...
#if !defined(ARCADIA_RING2_FILESYSTEM_DIRECTORYITERATOR_H_INCLUDED)
#define ARCADIA_RING2_FILESYSTEM_DIRECTORYITERATOR_H_INCLUDED
...
#endif // ARCADIA_RING2_FILESYSTEM_DIRECTORYITERATOR_H_INCLUDED
