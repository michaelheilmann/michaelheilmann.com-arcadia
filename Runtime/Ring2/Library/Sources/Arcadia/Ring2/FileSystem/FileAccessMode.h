...
#if !defined(ARCADIA_RING2_FILESYSTEM_FILEACCESSMODE_H_INCLUDED)
#define ARCADIA_RING2_FILESYSTEM_FILEACCESSMODE_H_INCLUDED
...
#endif // ARCADIA_RING2_FILESYSTEM_FILEACCESSMODE_H_INCLUDED
