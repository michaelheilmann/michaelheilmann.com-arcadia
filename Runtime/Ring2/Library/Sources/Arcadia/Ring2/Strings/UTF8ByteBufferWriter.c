...
static void
Arcadia_UTF8ByteBufferWriter_flushImpl
  (
    Arcadia_Thread* thread,
    Arcadia_UTF8ByteBufferWriter* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_UTF8ByteBufferWriter_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_UTF8ByteBufferWriter_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_UTF8ByteBufferWriter_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_UTF8ByteBufferWriter);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_UTF8ByteBufferWriter);
}
...
{
  Arcadia_ByteBuffer_insertBackBytes(thread, self->target, Arcadia_String_getBytes(thread, string), Arcadia_String_getNumberOfBytes(thread, string));
}
