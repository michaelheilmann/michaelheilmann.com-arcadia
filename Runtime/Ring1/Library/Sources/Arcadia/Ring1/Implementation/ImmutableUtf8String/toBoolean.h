...
#if !defined(ARCADIA_RING1_IMPLEMENTATION_IMMUTABLEUTF8STRING_TOBOOLEAN_H_INCLUDED)
...
#endif // ARCADIA_RING1_IMPLEMENTATION_IMMUTABLEUTF8STRING_TOBOOLEAN_H_INCLUDED
