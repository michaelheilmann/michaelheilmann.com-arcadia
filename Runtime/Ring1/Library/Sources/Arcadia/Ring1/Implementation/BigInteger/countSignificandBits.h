...
#if !defined(ARCADIA_RING1_IMPLEMENTATION_BIGINTEGER_COUNTSIGNIFICANDBITS_H_INCLUDED)
#define ARCADIA_RING1_IMPLEMENTATION_BIGINTEGER_COUNTSIGNIFICANDBITS_H_INCLUDED
