  ...
  )
{
  ...
  if (Arcadia_Value_isNatural8Value(&y)) {
    ...
    Arcadia_ValueStack_pushBooleanValue(thread, (Arcadia_Natural32Value)Arcadia_Value_getNatural16Value(&x) == (Arcadia_Natural64Value)Arcadia_Value_getNatural32Value(&y));
  } else if (Arcadia_Value_isNatural64Value(&y)) {
  ...
  )
{
  BINARY_OPERATION();
  if (Arcadia_Value_isNatural8Value(&y)) {
    Arcadia_ValueStack_pushBooleanValue(thread, Arcadia_Value_getNatural8Value(&x) == Arcadia_Value_getNatural8Value(&y));
  } else {
    Arcadia_ValueStack_pushBooleanValue(thread, Arcadia_BooleanValue_False);
  }
}
  ...
  )
{
  ...
  if (Arcadia_Value_isNatural8Value(&y)) {
    ...
    Arcadia_ValueStack_pushBooleanValue(thread, (Arcadia_Natural16Value)Arcadia_Value_getNatural8Value(&x) != Arcadia_Value_getNatural16Value(&y));
  } else if (Arcadia_Value_isNatural32Value(&y)) {
    Arcadia_ValueStack_pushBooleanValue(thread, (Arcadia_Natural32Value)Arcadia_Value_getNatural8Value(&x) != Arcadia_Value_getNatural32Value(&y));
  } else if (Arcadia_Value_isNatural64Value(&y)) {
    Arcadia_ValueStack_pushBooleanValue(thread, (Arcadia_Natural64Value)Arcadia_Value_getNatural8Value(&x) != Arcadia_Value_getNatural64Value(&y));
  } else {
  ...
  )
{
  BINARY_OPERATION();
  if (Arcadia_Value_isNatural8Value(&y)) {
    Arcadia_ValueStack_pushNatural8Value(thread, Arcadia_Value_getNatural8Value(&x) - Arcadia_Value_getNatural8Value(&y));
  } else if (Arcadia_Value_isNatural16Value(&y)) {
    Arcadia_ValueStack_pushNatural16Value(thread, (Arcadia_Natural16Value)Arcadia_Value_getNatural8Value(&x) - Arcadia_Value_getNatural16Value(&y));
  } else if (Arcadia_Value_isNatural32Value(&y)) {
    Arcadia_ValueStack_pushNatural32Value(thread, (Arcadia_Natural32Value)Arcadia_Value_getNatural8Value(&x) - Arcadia_Value_getNatural32Value(&y));
  } else if (Arcadia_Value_isNatural64Value(&y)) {
    Arcadia_ValueStack_pushNatural64Value(thread, (Arcadia_Natural64Value)Arcadia_Value_getNatural8Value(&x) - Arcadia_Value_getNatural64Value(&y));
  } else {
    Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentTypeInvalid);
    Arcadia_Thread_jump(thread);
  }
...
Arcadia_defineScalarType(Arcadia_Natural8, u8"Arcadia.Natural8", &_typeOperations);
