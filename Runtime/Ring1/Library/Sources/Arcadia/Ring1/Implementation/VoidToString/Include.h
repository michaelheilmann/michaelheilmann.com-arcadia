...
#if !defined(ARCADIA_RING1_IMPLEMENTATION_VOIDTOSTRING_INCLUDE_H_INCLUDED)
#define ARCADIA_RING1_IMPLEMENTATION_VOIDTOSTRING_INCLUDE_H_INCLUDED
...
#endif // ARCADIA_RING1_IMPLEMENTATION_VOIDTOSTRING_INCLUDE_H_INCLUDED
