...
<section class="cxx entity typedef">
  ...
  <h1 id="Arcadia_VoidValue">Arcadia_VoidValue</h1>
...
<section class="cxx entity define">
  ...
  <h1 id="Arcadia_VoidValue_Void">Arcadia_VoidValue_Void</h1>
...
<section class="cxx entity define">
  ...
  <h1 id="Arcadia_VoidValue_NumberOfBits">Arcadia_VoidValue_NumberOfBits</h1>
 ...
 <section class="cxx entity define">
  ...
  <h1 id="Arcadia_VoidValue_NumberOfBytes">Arcadia_VoidValue_NumberOfBytes</h1>
