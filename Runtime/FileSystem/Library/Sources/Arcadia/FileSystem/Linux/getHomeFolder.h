...
#if !defined(ARCADIA_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED)
#define ARCADIA_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_LINUX_GETHOMEFOLDER_H_INCLUDED
