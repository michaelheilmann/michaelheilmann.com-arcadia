...
#if !defined(ARCADIA_FILESYSTEM_FILEACCESSMODE_H_INCLUDED)
#define ARCADIA_FILESYSTEM_FILEACCESSMODE_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_FILEACCESSMODE_H_INCLUDED
