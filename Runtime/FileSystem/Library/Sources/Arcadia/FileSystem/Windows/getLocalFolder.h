...
#if !defined(ARCADIA_FILESYSTEM_WINDOWS_GETLOCALFOLDER_H_INCLUDED)
#define ARCADIA_FILESYSTEM_WINDOWS_GETLOCALFOLDER_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_WINDOWS_GETLOCALFOLDER_H_INCLUDED
