...
#if !defined(ARCADIA_FILESYSTEM_IMPLEMENTATION_GETFILETYPE_H_INCLUDED)
#define ARCADIA_FILESYSTEM_IMPLEMENTATION_GETFILETYPE_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_IMPLEMENTATION_GETFILETYPE_H_INCLUDED
