...
#if !defined(ARCADIA_FILESYSTEM_IMPLEMENTATION_DELETEREGULARFILE_H_INCLUDED)
#define ARCADIA_FILESYSTEM_IMPLEMENTATION_DELETEREGULARFILE_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_IMPLEMENTATION_DELETEREGULARFILE_H_INCLUDED
