...
#if !defined(ARCADIA_FILESYSTEM_EXISTINGFILEPOLICY_H_INCLUDED)
#define ARCADIA_FILESYSTEM_EXISTINGFILEPOLICY_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_EXISTINGFILEPOLICY_H_INCLUDED
