...
static void
Arcadia_Engine_Audials_Implementation_BackendContext_updateImpl
  (
...
static void
Arcadia_Engine_Audials_Implementation_BackendContext_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Audials_Implementation_BackendContext* self
  );
...
static void
Arcadia_Engine_Audials_Implementation_BackendContext_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
...
static void
Arcadia_Engine_Audials_Implementation_BackendContext_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Audials_Implementation_BackendContext* self
  );
