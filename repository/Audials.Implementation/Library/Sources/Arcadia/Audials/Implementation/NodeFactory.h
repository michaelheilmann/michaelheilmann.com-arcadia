...
struct Arcadia_Engine_Audials_Implementation_NodeFactoryDispatch {
  Arcadia_Engine_Audials_NodeFactoryDispatch parent;
};

struct Arcadia_Engine_Audials_Implementation_NodeFactory {
  Arcadia_Engine_Audials_NodeFactory parent;
};
...
#endif // ARCADIA_ENGINE_AUDIALS_IMPLEMENTATION_NODEFACTORY_H_INCLUDED
