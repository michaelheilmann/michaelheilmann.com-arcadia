...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_destructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self
  );
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self
  );
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_renderImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self,
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_setVisualsBackendContextImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self,
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_setSizeImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self,
...
static void
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_getSizeImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Engine_Visuals_Implementation_FrameBufferNode* self,
    Arcadia_Integer32Value* width,
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Engine_Visuals_Implementation_FrameBufferNode_constructImpl,
  .destruct = (Arcadia_Object_DestructCallbackFunction*)&Arcadia_Engine_Visuals_Implementation_FrameBufferNode_destructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_Engine_Visuals_Implementation_FrameBufferNode_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Engine_Visuals_Implementation_FrameBufferNode_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Visuals.Implementation.FrameBufferNode", Arcadia_Engine_Visuals_Implementation_FrameBufferNode,
                         u8"Arcadia.Engine.Visuals.FrameBufferNode", Arcadia_Visuals_FrameBufferNode,
                         &_typeOperations);
...
Arcadia_Engine_Visuals_Implementation_FrameBufferNode*
Arcadia_Engine_Visuals_Implementation_FrameBufferNode_create
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_BackendContext* backendContext
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Engine_Visuals_Implementation_FrameBufferNode);
}
