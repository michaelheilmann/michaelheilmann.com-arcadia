...
#if !defined(ARCADIA_VISUALS_IMPLEMENTATION_NODES_RENDERINGCONTEXTNODE_H_INCLUDED)
#define ARCADIA_VISUALS_IMPLEMENTATION_NODES_RENDERINGCONTEXTNODE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.Implementation.RenderingContextNode", Arcadia_Engine_Visuals_Implementation_RenderingContextNode,
                          u8"Arcadia.Engine.Visuals.RenderingContextNode");

struct Arcadia_Engine_Visuals_Implementation_RenderingContextNodeDispatch {
  Arcadia_Engine_Visuals_RenderingContextNodeDispatch parent;
};

struct Arcadia_Engine_Visuals_Implementation_RenderingContextNode {
  Arcadia_Engine_Visuals_RenderingContextNode parent;
...
#endif // ARCADIA_VISUALS_IMPLEMENTATION_NODES_RENDERINGCONTEXTNODE_H_INCLUDED
