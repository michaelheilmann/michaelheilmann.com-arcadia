...
static const Arcadia_ObjectType_Operations _Arcadia_Visuals_Implementation_Direct3D12_Backend_objectTypeOperations = {
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_Implementation_Direct3D12_Backend_construct,
  .destruct = (Arcadia_Object_DestructCallbackFunction*)&Arcadia_Visuals_Implementation_Direct3D12_Backend_destruct,
...
{
  Arcadia_EnterConstructor(Arcadia_Visuals_Implementation_Direct3D12_Backend);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_Visuals_Implementation_Direct3D12_Backend);
}
