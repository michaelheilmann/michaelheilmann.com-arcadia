...
static void
Arcadia_Visuals_Implementation_MeshResource_constructImpl
  (
...
static void
Arcadia_Visuals_Implementation_MeshResource_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_MeshResource* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Visuals_Implementation_MeshResource_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Implementation.MeshResource", Arcadia_Visuals_Implementation_MeshResource,
