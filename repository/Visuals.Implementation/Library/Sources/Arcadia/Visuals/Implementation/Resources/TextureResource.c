...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Visuals_Implementation_TextureResource_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_Visuals_Implementation_TextureResource);
  ...
  Arcadia_LeaveConstructor(Arcadia_Visuals_Implementation_TextureResource);
}
