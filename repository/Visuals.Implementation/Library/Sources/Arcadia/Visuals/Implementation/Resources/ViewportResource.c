...
static void
Arcadia_Visuals_Implementation_ViewportResource_constructImpl
  (
...
static void
Arcadia_Visuals_Implementation_ViewportResource_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_ViewportResource* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Implementation.ViewportResource", Arcadia_Visuals_Implementation_ViewportResource,
...
{
  Arcadia_TypeValue _type = _Arcadia_Visuals_Implementation_ViewportResource_getType(thread);
