...
#if !defined(ARCADIA_VISUALS_IMPLEMENTATION_MATERIALRESOURCE_H_INCLUDED)
#define ARCADIA_VISUALS_IMPLEMENTATION_MATERIALRESOURCE_H_INCLUDED
...
struct Arcadia_Visuals_Implementation_MaterialResourceDispatch {
  Arcadia_Visuals_Implementation_ResourceDispatch _parent;
};

struct Arcadia_Visuals_Implementation_MaterialResource {
  Arcadia_Visuals_Implementation_Resource _parent;
};

#endif // ARCADIA_VISUALS_IMPLEMENTATION_MATERIALRESOURCE_H_INCLUDED
