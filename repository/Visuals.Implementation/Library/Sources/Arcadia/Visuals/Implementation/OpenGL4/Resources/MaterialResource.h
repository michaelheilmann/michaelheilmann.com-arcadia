...
#if !defined(ARCADIA_VISUALS_IMPLEMENTATION_OPENGL4_RESOURCES_MATERIALRESOURCE_H_INCLUDED)
...
Arcadia_declareObjectType(u8"Arcadia.Visuals.Implementation.OpenGL4.MaterialResource", Arcadia_Visuals_Implementation_OpenGL4_MaterialResource,
                          u8"Arcadia.Visuals.Implementation.MaterialResource");

struct Arcadia_Visuals_Implementation_OpenGL4_MaterialResourceDispatch {
  Arcadia_Visuals_Implementation_MaterialResourceDispatch _parent;
};
...
#endif // ARCADIA_VISUALS_IMPLEMENTATION_OPENGL4_RESOURCES_MATERIALRESOURCE_H_INCLUDED
