...
/// }
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.Visuals.Implementation.OpenGL4.WGL.BackendContext", Arcadia_Engine_Visuals_Implementation_OpenGL4_WGL_BackendContext,
