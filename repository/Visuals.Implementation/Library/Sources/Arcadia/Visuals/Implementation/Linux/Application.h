...
#if !defined(ARCADIA_VISUALS_LINUX_APPLICATION_H_INCLUDED)
#define ARCADIA_VISUALS_LINUX_APPLICATION_H_INCLUDED
...
/// }
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.Visuals.Linux.Application", Arcadia_Visuals_Linux_Application,
...
struct Arcadia_Visuals_Linux_Application {
  ...
  /// If the appllication has received a quit request.
...
#endif // ARCADIA_VISUALS_LINUX_APPLICATION_H_INCLUDED
