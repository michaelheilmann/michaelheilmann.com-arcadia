...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Visuals_Implementation_BackendContext_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_Visuals_Implementation_BackendContext);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_Visuals_Implementation_BackendContext);
}
...
{ Arcadia_VirtualCallWithReturn(Arcadia_Visuals_Implementation_BackendContext, createModelResource, self, mesh, material); }
