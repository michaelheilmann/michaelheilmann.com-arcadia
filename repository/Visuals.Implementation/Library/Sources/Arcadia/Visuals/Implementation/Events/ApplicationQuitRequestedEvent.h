...
#include "Arcadia/Visuals/Implementation/Events/ApplicationEvent.h"
typedef struct Arcadia_Visuals_Application Arcadia_Visuals_Application;
...
Arcadia_Visuals_ApplicationQuitRequestedEvent_create
  (
    ...
    Arcadia_Visuals_Application* application
  );
