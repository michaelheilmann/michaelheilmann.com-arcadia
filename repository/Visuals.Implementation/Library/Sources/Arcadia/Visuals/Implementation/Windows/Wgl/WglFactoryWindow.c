...
#include "Arcadia/Visuals/Implementation/Windows/Wgl/WglFactorywindow.h"

#define WindowClassName "Arcadia.Visuals.Windows.WglFactoryWindow"
#define WindowTitle "Arcadia WGL Factory Window"
...
static void
Arcadia_Visuals_Windows_WglFactoryWindow_destruct
  (
...
static void
Arcadia_Visuals_Windows_WglFactoryWindow_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Value* self,
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Visuals_Windows_WglFactoryWindow_constructImpl,
  .destruct = &Arcadia_Visuals_Windows_WglFactoryWindow_destruct,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Windows.WglFactoryWindow", Arcadia_Visuals_Windows_WglFactoryWindow, u8"Arcadia.Object", Arcadia_Object, &_typeOperations);
...
{
  Arcadia_Visuals_Windows_WglFactoryWindow* _self = Arcadia_Value_getObjectReferenceValue(self);
  Arcadia_TypeValue _type = _Arcadia_Visuals_Windows_WglFactoryWindow_getType(thread);
  {
    Arcadia_Value argumentValues[] = {
  ...
  )
{
  ...
  Arcadia_Visuals_Windows_WglFactoryWindow* self = Arcadia_allocateObject(thread, _Arcadia_Visuals_Windows_WglFactoryWindow_getType(thread), 0, &argumentValues[0]);
  return self;
}
