...
Arcadia_declareObjectType(u8"Arcadia.Visuals.Implementation.Scene.MaterialNode", Arcadia_Visuals_Implementation_Scene_MaterialNode,
                          u8"Arcadia.Visuals.Scene.MaterialNode");

struct Arcadia_Visuals_Implementation_Scene_MaterialNodeDispatch {
  Arcadia_Visuals_Scene_MaterialNodeDispatch parent;
};

struct Arcadia_Visuals_Implementation_Scene_MaterialNode {
  Arcadia_Visuals_Scene_MaterialNode parent;
