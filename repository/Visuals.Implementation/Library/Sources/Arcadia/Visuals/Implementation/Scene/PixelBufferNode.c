...
static void
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Scene_PixelBufferNode* self
  );

static void
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Scene_PixelBufferNodeDispatch* self
  );

static void
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_destructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Scene_PixelBufferNode* self
  );
...
static void
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_renderImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Scene_PixelBufferNode* self,
...
static void
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_setBackendContextImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Scene_PixelBufferNode* self,
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_Implementation_Scene_PixelBufferNode_constructImpl,
  .destruct = (Arcadia_Object_DestructCallbackFunction*)&Arcadia_Visuals_Implementation_Scene_PixelBufferNode_destructImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Implementation.Scene.PixelBufferNode", Arcadia_Visuals_Implementation_Scene_PixelBufferNode,
                         u8"Arcadia.Visuals.Scene.PixelBufferNode", Arcadia_Visuals_Scene_PixelBufferNode,
                         &_typeOperations);
...
{
  Arcadia_TypeValue _type = _Arcadia_Visuals_Implementation_Scene_PixelBufferNode_getType(thread);
...
{
  ((Arcadia_Visuals_Scene_NodeDispatch*)self)->render = (void (*)(Arcadia_Thread*, Arcadia_Visuals_Scene_Node*, Arcadia_Visuals_Scene_RenderingContextNode*)) & Arcadia_Visuals_Implementation_Scene_PixelBufferNode_renderImpl;
  ((Arcadia_Visuals_Scene_NodeDispatch*)self)->setBackendContext = (void (*)(Arcadia_Thread*, Arcadia_Visuals_Scene_Node*, Arcadia_Visuals_BackendContext*)) & Arcadia_Visuals_Implementation_Scene_PixelBufferNode_setBackendContextImpl;
}
...
Arcadia_Visuals_Implementation_Scene_PixelBufferNode*
Arcadia_Visuals_Implementation_Scene_PixelBufferNode_create
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_BackendContext* backendContext,
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Visuals_Implementation_Scene_PixelBufferNode);
}
