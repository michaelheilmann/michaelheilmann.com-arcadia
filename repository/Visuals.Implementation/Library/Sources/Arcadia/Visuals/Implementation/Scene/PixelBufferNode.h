...
Arcadia_declareObjectType(u8"Arcadia.Visuals.Implementation.Scene.PixelBufferNode", Arcadia_Visuals_Implementation_Scene_PixelBufferNode,
                          u8"Arcadia.Visuals.Scene.PixelBufferNode");

struct Arcadia_Visuals_Implementation_Scene_PixelBufferNodeDispatch {
  Arcadia_Visuals_Scene_PixelBufferNodeDispatch parent;
};

struct Arcadia_Visuals_Implementation_Scene_PixelBufferNode {
  Arcadia_Visuals_Scene_PixelBufferNode parent;
  // The backend context.
