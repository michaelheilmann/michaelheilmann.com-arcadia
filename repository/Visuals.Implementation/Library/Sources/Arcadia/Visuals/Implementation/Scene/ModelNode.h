...
#if !defined(ARCADIA_VISUALS_IMPLEMENTATION_SCENE_MODELNODE_H_INCLUDED)
#define ARCADIA_VISUALS_IMPLEMENTATION_SCENE_MODELNODE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.Visuals.Implementation.Scene.ModelNode", Arcadia_Visuals_Implementation_Scene_ModelNode,
                          u8"Arcadia.Visuals.Scene.ModelNode");

struct Arcadia_Visuals_Implementation_Scene_ModelNodeDispatch {
  Arcadia_Visuals_Scene_ModelNodeDispatch _parent;
};

struct Arcadia_Visuals_Implementation_Scene_ModelNode {
  Arcadia_Visuals_Scene_ModelNode _parent;
...
#endif // ARCADIA_VISUALS_IMPLEMENTATION_SCENE_MODELNODE_H_INCLUDED
