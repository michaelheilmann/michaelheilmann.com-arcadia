...
struct Arcadia_Visuals_Implementation_BackendContext {
  ...
  Arcadia_Visuals_Implementation_FragmentProgramResource* (*createFragmentProgramResource)
    (
      Arcadia_Thread* thread,
      Arcadia_Visuals_Implementation_BackendContext* self
    );

  Arcadia_Visuals_Implementation_ProgramResource* (*createProgramResource)
    (
      Arcadia_Thread* thread,
      Arcadia_Visuals_Implementation_BackendContext* self,
  ...
  Arcadia_Visuals_Implementation_VertexBufferResource* (*createVertexBufferResource)
    (
      Arcadia_Thread* thread,
      Arcadia_Visuals_Implementation_BackendContext* self
    );

  Arcadia_Visuals_Implementation_VertexProgramResource* (*createVertexProgramResource)
    (
      Arcadia_Thread* thread,
      Arcadia_Visuals_Implementation_BackendContext* self
    );

  Arcadia_Visuals_Implementation_ViewportResource* (*createViewportResource)
    (
      Arcadia_Thread* thread,
      Arcadia_Visuals_Implementation_BackendContext* self
    );
