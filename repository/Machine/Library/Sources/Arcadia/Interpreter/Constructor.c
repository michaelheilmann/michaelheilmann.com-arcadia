...
static void
R_Interpreter_Constructor_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    R_Interpreter_ConstructorDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&R_Interpreter_Constructor_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&R_Interpreter_Constructor_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&R_Interpreter_Constructor_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(R_Interpreter_Constructor);
  {
  ...
  Arcadia_LeaveConstructor(R_Interpreter_Constructor);
}
...
{
  _Arcadia_BeginCreate(R_Interpreter_Constructor);
  if (foreignProcedure) {
  ...
  _Arcadia_EndCreate(R_Interpreter_Constructor);
}
