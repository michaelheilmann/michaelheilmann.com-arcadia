...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&R_Interpreter_Procedure_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(R_Interpreter_Procedure);
  {
  ...
  Arcadia_LeaveConstructor(R_Interpreter_Procedure);
}
