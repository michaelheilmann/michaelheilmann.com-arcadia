...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_Pass_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_Pass);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_Pass);
}
