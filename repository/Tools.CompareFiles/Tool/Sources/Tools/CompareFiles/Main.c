  ...
  )
{
  ...
  Arcadia_FilePath* firstFile = Arcadia_FilePath_parseNative(thread, Arcadia_String_create_pn(thread, Arcadia_ImmutableByteArray_create(thread, argv[1], strlen(argv[1]))));
  Arcadia_FilePath* secondFile = Arcadia_FilePath_parseNative(thread, Arcadia_String_create_pn(thread, Arcadia_ImmutableByteArray_create(thread, argv[2], strlen(argv[2]))));
