...
#if !defined(ARCADIA_VISUALS_VPL_BACKENDS_GLSL_INCLUDE_H_INCLUDED)
#define ARCADIA_VISUALS_VPL_BACKENDS_GLSL_INCLUDE_H_INCLUDED
...
#endif // ARCADIA_VISUALS_VPL_BACKENDS_GLSL_INCLUDE_H_INCLUDED
