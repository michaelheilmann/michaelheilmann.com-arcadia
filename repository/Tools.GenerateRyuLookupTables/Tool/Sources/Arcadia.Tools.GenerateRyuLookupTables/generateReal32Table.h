...
#if !defined(ARCADIA_TOOLS_RYULOOKUPTABLEGENERATOR_GENERATEREAL32TABLE_H_INCLUDED)
#define ARCADIA_TOOLS_RYULOOKUPTABLEGENERATOR_GENERATEREAL32TABLE_H_INCLUDED
