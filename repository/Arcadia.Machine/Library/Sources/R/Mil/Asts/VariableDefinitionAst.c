...
Arcadia_defineObjectType(u8"Arcadia.Mil.VariableDefinitionAst", Arcadia_Mil_VariableDefinitionAst, u8"Arcadia.Mil.ClassMemberDefinitionAst", Arcadia_Mil_ClassMemberDefinitionAst, &_Arcadia_Mil_VariableDefinitionAst_typeOperations);
