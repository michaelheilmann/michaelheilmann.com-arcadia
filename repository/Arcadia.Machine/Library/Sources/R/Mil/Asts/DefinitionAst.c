...
Arcadia_defineObjectType(u8"Arcadia.Mil.DefinitionAst", Arcadia_Mil_DefinitionAst, u8"Arcadia.Mil.Ast", Arcadia_Mil_Ast, &_Arcadia_Mil_DefinitionAst_typeOperations);
