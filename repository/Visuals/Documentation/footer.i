  ...
  <div class="right-column">
    <nav>
      <ul style="list-style: none">
        ...
        <li><a href="@{siteAddress}/Arcadia/Visuals/#Arcadia_Visuals_ApplicationQuitRequestedEvent_constructt0">[MIL] Arcadia.Visuals.ApplicationQuitRequestedEvent.construct</a></li>
        <li><a href="@{siteAddress}/Arcadia/Visuals/#Arcadia_Visuals_CanvasEvent">[MIL] Arcadia.Visuals.CanvasEvent</a></li>
        ...
        <li><a href="@{siteAddress}/Arcadia/Visuals/#Arcadia_Visuals_WindowSizeChanged.construct">[MIL] Arcadia.Visuals.WindowSizeChanged.construct</a></li>
      </ul>
    </nav>
  </div>
  </main>
  <footer>
    ...
    <div class="right-column">
      ...
      <div>Last modified on 2 May 2025.</div>
    </div>
  </footer>
  </body>
</html>
