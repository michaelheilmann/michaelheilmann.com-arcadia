...
#include "Arcadia/Visuals/Windows/DisplayMode.h"
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Windows.DisplayMode", Arcadia_Visuals_Windows_DisplayMode, u8"Arcadia.Visuals.DisplayMode", Arcadia_Visuals_DisplayMode, &_typeOperations);
