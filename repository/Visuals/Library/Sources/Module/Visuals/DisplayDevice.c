...
Arcadia_defineObjectType(u8"Arcadia.Visuals.DisplayDevice", Arcadia_Visuals_DisplayDevice, u8"Arcadia.Object", Arcadia_Object, &_typeOperations);
...
{ 
  return self->getDisplayModes(thread, self);
}
