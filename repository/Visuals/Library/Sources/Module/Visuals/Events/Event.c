...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Visuals_Event_constructImpl,
  .destruct = NULL,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Event", Arcadia_Visuals_Event, u8"Arcadia.Object", Arcadia_Object, &_typeOperations);
