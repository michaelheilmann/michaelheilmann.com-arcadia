...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Visuals_DisplayMode_constructImpl,
  .destruct = NULL,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.DisplayMode", Arcadia_Visuals_DisplayMode, u8"Arcadia.Object", Arcadia_Object, &_typeOperations);
...
{
  Arcadia_Visuals_DisplayMode* _self = Arcadia_Value_getObjectReferenceValue(self);
