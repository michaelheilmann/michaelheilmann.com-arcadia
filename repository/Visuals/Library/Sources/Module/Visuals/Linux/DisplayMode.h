...
#if !defined (ARCADIA_VISUALS_LINUX_DISPLAYMODE_H_INCLUDED)
#define ARCADIA_VISUALS_LINUX_DISPLAYMODE_H_INCLUDED
...
#endif // ARCADIA_VISUALS_LINUX_DISPLAYMODE_H_INCLUDED
