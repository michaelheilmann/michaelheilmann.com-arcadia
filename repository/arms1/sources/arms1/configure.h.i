...
#if !defined(ARMS1_CONFIGURE_H_INCLUDED)
#define ARMS1_CONFIGURE_H_INCLUDED
...
#define Arms_Configuration_CompileC @Arcadia.Arms.Configuration.Compiler.C@

#endif // ARMS1_CONFIGURE_H_INCLUDED
