  ...
  <ul>
    <li><a href="https://michaelheilmann.com/repository/arms1/sources/arcadia/arms1.c">sources/arcadia/arms1.c</a></li>
    <li><a href="https://michaelheilmann.com/repository/arms1/sources/arcadia/arms1.h">sources/arcadia/arms1.h</a></li>
  ...
  <p>Initially, ARMS1 is not started and its API cannot be used unless otherwise stated.
  To startup ARMS1 the user invokes <code>Arms_Status Arms_startup()</code>.
  If this function succeeds then it returns <code>Arms_Status_Success</code> and ARMS1 is started.
  If this function fails it returns a value different from
  ...
  <p>To shutdown ARMS, the user invokes <code>Arms_Status Arms_shutdown()</code>. If this function succeeds then
  it returns <code>Arms_Status_Success</code> and ARMS1 is stopped. 
  If this function fails it returns a value different from
  <code>Arms_Status_Success</code>. The following table lists the possible values returned in case of failure
  </p>
  <table>
  ...
  <p><b>Warning:</b>
  Calling <code>Arms_startup</code> if ARMS1 is started triggers undefined behavior.
  Calling <code>Arms_shutdown</code> if ARMS1 is stopped triggers undefined behavior.
  </p>
