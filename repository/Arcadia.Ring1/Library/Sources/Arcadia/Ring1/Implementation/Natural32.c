...
{
#define A1 &(arguments[0])
  Arcadia_Value_setSizeValue(target, (Arcadia_SizeValue)Arcadia_Value_getNatural32Value(A1));
#undef A1
}
...
#define A2 &(arguments[1])
  if (Arcadia_Value_isNatural8Value(A2)) {
    Arcadia_Value_setBooleanValue(target, Arcadia_Value_getNatural32Value(A1) != Arcadia_Value_getNatural8Value(A2));
  } else if (Arcadia_Value_isNatural16Value(A2)) {
    Arcadia_Value_setBooleanValue(target, (Arcadia_Natural16Value)Arcadia_Value_getNatural32Value(A1) != Arcadia_Value_getNatural16Value(A2));
  } else if (Arcadia_Value_isNatural32Value(A2)) {
    Arcadia_Value_setBooleanValue(target, (Arcadia_Natural32Value)Arcadia_Value_getNatural32Value(A1) != Arcadia_Value_getNatural32Value(A2));
  } else if (Arcadia_Value_isNatural64Value(A2)) {
    Arcadia_Value_setBooleanValue(target, (Arcadia_Natural64Value)Arcadia_Value_getNatural32Value(A1) != Arcadia_Value_getNatural64Value(A2));
  } else {
...
#define A2 &(arguments[1])
  if (Arcadia_Value_isNatural8Value(A2)) {
    Arcadia_Value_setNatural32Value(target, Arcadia_Value_getNatural32Value(A1) - Arcadia_Value_getNatural8Value(A2));
  } else if (Arcadia_Value_isNatural16Value(A2)) {
    Arcadia_Value_setNatural32Value(target, (Arcadia_Natural16Value)Arcadia_Value_getNatural32Value(A1) - Arcadia_Value_getNatural16Value(A2));
  } else if (Arcadia_Value_isNatural32Value(A2)) {
    Arcadia_Value_setNatural32Value(target, (Arcadia_Natural32Value)Arcadia_Value_getNatural32Value(A1) - Arcadia_Value_getNatural32Value(A2));
  } else if (Arcadia_Value_isNatural64Value(A2)) {
    Arcadia_Value_setNatural64Value(target, (Arcadia_Natural64Value)Arcadia_Value_getNatural32Value(A1) - Arcadia_Value_getNatural64Value(A2));
  } else {
    Arcadia_Thread_setStatus(Arcadia_Process_getThread(process), Arcadia_Status_ArgumentTypeInvalid);
