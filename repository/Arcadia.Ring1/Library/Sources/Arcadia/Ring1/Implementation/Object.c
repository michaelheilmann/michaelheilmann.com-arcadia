  ...
  )
{
  ...
  operations->add(process, &resultValue, 2, &args[0]);
  return Arcadia_Value_getObjectReferenceValue(&resultValue);
}

Arcadia_Object*
Arcadia_Object_subtract
  (
    Arcadia_Process* process,
    Arcadia_Object* self,
    Arcadia_Value const* other
  )
{
  ...
  Arcadia_Value resultValue;
  Arcadia_Value args[2] = { {.tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = self }, *other };
  operations->subtract(process, &resultValue, 2, &args[0]);
  return Arcadia_Value_getObjectReferenceValue(&resultValue);
}
...
Arcadia_BooleanValue
Arcadia_Object_greaterThanOrEqualTo
  (
    Arcadia_Process* process,
    Arcadia_Object* self,
    Arcadia_Value const* other
...
Arcadia_BooleanValue
Arcadia_Object_lowerThanOrEqualTo
  (
    Arcadia_Process* process,
    Arcadia_Object* self,
    Arcadia_Value const* other
  ...
  )
{
  ...
  Arcadia_Type_Operations const* operations = Arcadia_Type_getOperations(type);
  Arcadia_Value resultValue;
  Arcadia_Value args[2] = { {.tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = self }, };
  operations->toString(process, &resultValue, 1, &args[0]);
  return Arcadia_Value_getObjectReferenceValue(&resultValue);
}
