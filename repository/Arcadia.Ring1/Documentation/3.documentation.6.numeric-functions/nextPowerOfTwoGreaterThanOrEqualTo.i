<h4 id="Arcadia_nextPowerOfTwoGreaterThanOrEqualTo*">Arcadia_nextPowerOfTwoGreaterThanOrEqualTo*</h4>
<p>Arcadia Ring 1 provides functions returning the next power of two greater or equal to a value.</p>
<p><code>
<my-mv>Type</my-mv>
