...
#if !defined(ARCADIA_RING1_IMPLEMENTATION_NUMERICS_COUNTSIGNIFICANDBITS_H_INCLUDED)
#define ARCADIA_RING1_IMPLEMENTATION_NUMERICS_COUNTSIGNIFICANDBITS_H_INCLUDED
...
#define Define(Type, Suffix) \
  Arcadia_SizeValue \
  Arcadia_countSignificandBits##Suffix##Value \
    ( \
...
#endif // ARCADIA_RING1_IMPLEMENTATION_NUMERICS_COUNTSIGNIFICANDBITS_H_INCLUDED
