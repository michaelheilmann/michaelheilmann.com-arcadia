  ...
  )
{
  if (R_Value_isInteger8Value(other)) {
    ...
    R_Value_setInteger16Value(target, (Arcadia_Integer16Value)R_Value_getInteger8Value(self) + R_Value_getInteger16Value(other));
  } else if (R_Value_isInteger32Value(other)) {
    R_Value_setInteger32Value(target, (Arcadia_Integer32Value)R_Value_getInteger8Value(self) + R_Value_getInteger32Value(other));
  } else if (R_Value_isInteger64Value(other)) {
    R_Value_setInteger64Value(target, (Arcadia_Integer64Value)R_Value_getInteger8Value(self) + R_Value_getInteger64Value(other));
  } else {
...
{
  R_Value_setSizeValue(target, (Arcadia_SizeValue)R_Value_getInteger8Value(self));
}
