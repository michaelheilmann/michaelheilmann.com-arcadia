...
static const Arcadia_ObjectType_Operations _R_Mil_RealLiteralOperandAst_objectTypeOperations = {
...
{
  R_Mil_RealLiteralOperandAst* _self = Arcadia_Value_getObjectReferenceValue(self);
