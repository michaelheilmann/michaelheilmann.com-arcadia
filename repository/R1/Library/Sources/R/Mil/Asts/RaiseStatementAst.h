...
#if !defined(ARCADIA_MIL_ASTS_RAISESTATEMENTAST_H_INCLUDED)
#define ARCADIA_MIL_ASTS_RAISESTATEMENTAST_H_INCLUDED
...
/// 'raise'
/// @endcode
Rex_declareObjectType(u8"Arcadia.Mil.RaiseStatementAst", Arcadia_Mil_RaiseStatementAst, u8"Arcadia.Mil.StatementAst");
...
#endif // ARCADIA_MIL_ASTS_RAISESTATEMENTAST_H_INCLUDED
