...
Rex_defineObjectType(u8"Arcadia.Mil.LoadExpressionAst", Arcadia_Mil_LoadExpressionAst, u8"Arcadia.Mil.ExpressionAst", Arcadia_Mil_ExpressionAst, &_Arcadia_Mil_LoadExpressionAst_typeOperations);
  ...
  )
{
  ...
  Arcadia_TypeValue _type = _Arcadia_Mil_LoadExpressionAst_getType(process);
  {
...
{ 
  ...
  Arcadia_Mil_LoadExpressionAst* self = R_allocateObject(process, _Arcadia_Mil_LoadExpressionAst_getType(process), 1, &argumentValues[0]);
  return self;
}
