...
static const Arcadia_ObjectType_Operations _R_Mil_VariableDefinitionAst_objectTypeOperations = {
...
{
  R_Mil_VariableDefinitionAst* _self = Arcadia_Value_getObjectReferenceValue(self);
