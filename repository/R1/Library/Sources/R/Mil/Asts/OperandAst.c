...
Rex_defineObjectType(u8"Arcadia.Mil.OperandAst", Arcadia_Mil_OperandAst, u8"Arcadia.Mil.Ast", Arcadia_Mil_Ast, &_Arcadia_Mil_OperandAst_typeOperations);
  ...
  )
{
  ...
  Arcadia_TypeValue _type = _Arcadia_Mil_OperandAst_getType(process);
  {
