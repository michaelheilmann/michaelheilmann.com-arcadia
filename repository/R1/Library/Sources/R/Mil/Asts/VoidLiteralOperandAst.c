...
Rex_defineObjectType(u8"Arcadia.Mil.VoidLiteralOperandAst", Arcadia_Mil_VoidLiteralOperandAst, u8"Arcadia.Mil.OperandAst", Arcadia_Mil_OperandAst, &_Arcadia_Mil_VoidLiteralOperandAst_typeOperations);
  ...
  )
{
  ...
  Arcadia_TypeValue _type = _Arcadia_Mil_VoidLiteralOperandAst_getType(process);
  ...
  )
{
  ...
  Arcadia_Mil_VoidLiteralOperandAst* self = R_allocateObject(process, _Arcadia_Mil_VoidLiteralOperandAst_getType(process), 1, &argumentValues[0]);
  return self;
}
