...
static const Arcadia_ObjectType_Operations _R_Mil_VoidLiteralOperandAst_objectTypeOperations = {
  .construct = &R_Mil_VoidLiteralOperandAst_constructImpl,
  .destruct = NULL,
  .visit = &R_Mil_VoidLiteralOperandAst_visit,
};

static const Arcadia_Type_Operations _R_Mil_VoidLiteralOperandAst_typeOperations = {
...
Rex_defineObjectType(u8"R.Mil.VoidLiteralOperandAst", R_Mil_VoidLiteralOperandAst, u8"R.Mil.OperandAst", R_Mil_OperandAst, &_R_Mil_VoidLiteralOperandAst_typeOperations);
...
{
  R_Mil_VoidLiteralOperandAst* _self = Arcadia_Value_getObjectReferenceValue(self);
  Arcadia_TypeValue _type = _R_Mil_VoidLiteralOperandAst_getType(process);
  ...
  )
{
  ...
  R_Mil_VoidLiteralOperandAst* self = R_allocateObject(process, _R_Mil_VoidLiteralOperandAst_getType(process), 1, &argumentValues[0]);
  return self;
}
