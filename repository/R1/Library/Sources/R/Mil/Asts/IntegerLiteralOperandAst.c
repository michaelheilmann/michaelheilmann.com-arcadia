...
static const Arcadia_ObjectType_Operations _R_Mil_IntegerLiteralOperandAst_objectTypeOperations = {
  .construct = &R_Mil_IntegerLiteralOperandAst_constructImpl,
  .destruct = NULL,
  .visit = &R_Mil_IntegerLiteralOperandAst_visit,
};

static const Arcadia_Type_Operations _R_Mil_IntegerLiteralOperandAst_typeOperations = {
...
Rex_defineObjectType(u8"R.Mil.IntegerLiteralOperandAst", R_Mil_IntegerLiteralOperandAst, u8"R.Mil.OperandAst", R_Mil_OperandAst, &_R_Mil_IntegerLiteralOperandAst_typeOperations);
...
{
  R_Mil_IntegerLiteralOperandAst* _self = Arcadia_Value_getObjectReferenceValue(self);
  ...
  )
{
  ...
  R_Mil_IntegerLiteralOperandAst* self = R_allocateObject(process, _R_Mil_IntegerLiteralOperandAst_getType(process), 1, &argumentValues[0]);
  return self;
}
