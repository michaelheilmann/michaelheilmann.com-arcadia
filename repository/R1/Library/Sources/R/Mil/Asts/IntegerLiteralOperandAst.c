...
Rex_defineObjectType(u8"Arcadia.Mil.IntegerLiteralOperandAst", Arcadia_Mil_IntegerLiteralOperandAst, u8"Arcadia.Mil.OperandAst", Arcadia_Mil_OperandAst, &_Arcadia_Mil_IntegerLiteralOperandAst_typeOperations);
  ...
  )
{
  ...
  Arcadia_Mil_IntegerLiteralOperandAst* self = R_allocateObject(process, _Arcadia_Mil_IntegerLiteralOperandAst_getType(process), 1, &argumentValues[0]);
  return self;
}
