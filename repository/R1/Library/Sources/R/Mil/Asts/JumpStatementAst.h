...
#if !defined(ARCADIA_MIL_ASTS_JUMPSTATEMENTAST_H_INCLUDED)
#define ARCADIA_MIL_ASTS_JUMPSTATEMENTAST_H_INCLUDED
...
/// labelName : string
/// @endcode
Rex_declareObjectType(u8"Arcadia.Mil.JumpStatementAst", Arcadia_Mil_JumpStatementAst, u8"Arcadia.Mil.StatementAst");
...
#endif // ARCADIA_MIL_ASTS_JUMPSTATEMENTAST_H_INCLUDED
