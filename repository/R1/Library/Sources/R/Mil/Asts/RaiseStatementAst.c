...
Rex_defineObjectType(u8"Arcadia.Mil.RaiseStatementAst", Arcadia_Mil_RaiseStatementAst, u8"Arcadia.Mil.StatementAst", Arcadia_Mil_StatementAst, &_Arcadia_Mil_RaiseStatementAst_typeOperations);
