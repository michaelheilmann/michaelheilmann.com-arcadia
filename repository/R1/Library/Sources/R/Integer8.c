  ...
  )
{
  if (R_Value_isInteger8Value(other)) {
    R_Value_setInteger8Value(target, R_Value_getInteger8Value(self) + R_Value_getInteger8Value(other));
  } else if (R_Value_isInteger16Value(other)) {
    R_Value_setInteger16Value(target, (R_Integer16Value)R_Value_getInteger8Value(self) + R_Value_getInteger16Value(other));
  } else if (R_Value_isInteger32Value(other)) {
    R_Value_setInteger32Value(target, (R_Integer32Value)R_Value_getInteger8Value(self) + R_Value_getInteger32Value(other));
  } else if (R_Value_isInteger64Value(other)) {
    R_Value_setInteger64Value(target, (R_Integer64Value)R_Value_getInteger8Value(self) + R_Value_getInteger64Value(other));
  } else {
...
{
  R_Value_setSizeValue(target, (R_SizeValue)R_Value_getInteger8Value(self));
}
...
{
  R_Value_setInteger8Value(target, -R_Value_getInteger8Value(self));
}
...
R_Type*
_R_Integer8Value_getType
  (
  )
{
  if (!g_type) {
    R_registerIntegerType(u8"R.Integer8", sizeof("R.Integer8") - 1, &_typeOperations, &typeDestructing);
    g_type = R_getType(u8"R.Integer8", sizeof("R.Integer8") - 1);
  }
  return g_type;
}
