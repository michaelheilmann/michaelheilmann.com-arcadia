...
#define R_ForeignProcedureValue_NumberOfBytes (sizeof(void*))
  ...
  c_static_assert(R_ForeignProcedureValue_NumberOfBytes == 8, "R.ForeignProcedureValue.NumberOfBytes must be 8");
#elif R_Configuration_InstructionSetArchitecture == R_Configuration_InstructionSetArchitecture_X86
  c_static_assert(R_ForeignProcedureValue_NumberOfBytes == 4, "R.ForeignProcedureValue.NumberOfBytes must be 4");
#else
