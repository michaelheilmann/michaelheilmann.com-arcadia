  ...
  )
{
  ...
  Arcadia_List_appendObjectReferenceValue(thread, context->variables, name);
  ...
  )
{
  ...
  if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_VariableOperandAst_getType(thread))) {
  ...
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_BooleanLiteralOperandAst_getType(thread))) {
    Arcadia_Mil_BooleanLiteralOperandAst* booleanLiteralOperandAst = (Arcadia_Mil_BooleanLiteralOperandAst*)operandAst;
    R_Interpreter_Code_Constants_getOrCreateBoolean(Arcadia_Process_getThread(process), R_Interpreter_ProcessState_getConstants(interpreterProcessState), Arcadia_String_toBoolean(Arcadia_Process_getThread(process), booleanLiteralOperandAst->value));
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_IntegerLiteralOperandAst_getType(thread))) {
    Arcadia_Mil_IntegerLiteralOperandAst* integerLiteralOperandAst = (Arcadia_Mil_IntegerLiteralOperandAst*)operandAst;
    R_Interpreter_Code_Constants_getOrCreateInteger64(Arcadia_Process_getThread(process), R_Interpreter_ProcessState_getConstants(interpreterProcessState), Arcadia_String_toInteger64(Arcadia_Process_getThread(process), integerLiteralOperandAst->value));
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_RealLiteralOperandAst_getType(thread))) {
  ...
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_StringLiteralOperandAst_getType(thread))) {
    Arcadia_Mil_StringLiteralOperandAst* stringLiteralOperandAst = (Arcadia_Mil_StringLiteralOperandAst*)operandAst;
    R_Interpreter_Code_Constants_getOrCreateString(Arcadia_Process_getThread(process), R_Interpreter_ProcessState_getConstants(interpreterProcessState), stringLiteralOperandAst->value);
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(operandAst), _Arcadia_Mil_VoidLiteralOperandAst_getType(thread))) {
    Arcadia_Mil_VoidLiteralOperandAst* voidLiteralOperandAst = (Arcadia_Mil_VoidLiteralOperandAst*)operandAst;
    R_Interpreter_Code_Constants_getOrCreateVoid(Arcadia_Process_getThread(process), R_Interpreter_ProcessState_getConstants(interpreterProcessState), Arcadia_String_toVoid(Arcadia_Process_getThread(process), voidLiteralOperandAst->value));
  } else {
    Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentTypeInvalid);
  ...
  )
{
  ...
  if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(expressionAst), _Arcadia_Mil_LoadExpressionAst_getType(thread))) {
    ...
    context->statementIndex++;
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(expressionAst), _Arcadia_Mil_BinaryExpressionAst_getType(thread))) {
  ...
  } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(expressionAst), _Arcadia_Mil_UnaryExpressionAst_getType(thread))) {
  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, statements); i < n; ++i) {
    ...
    if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(statement), _Arcadia_Mil_LabelStatementAst_getType(thread))) {
      onLabelStatement(process, interpreterProcessState, code, context, (Arcadia_Mil_LabelStatementAst*)statement);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(statement), _Arcadia_Mil_RaiseStatementAst_getType(thread))) {
      onRaiseStatement(process, interpreterProcessState, code, context, (Arcadia_Mil_RaiseStatementAst*)statement);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(statement), _Arcadia_Mil_ReturnStatementAst_getType(thread))) {
      onReturnStatement(process, interpreterProcessState, code, context, (Arcadia_Mil_ReturnStatementAst*)statement);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(statement), _Arcadia_Mil_ExpressionStatementAst_getType(thread))) {
      onExpressionStatement(process, interpreterProcessState, code, context, (Arcadia_Mil_ExpressionStatementAst*)statement);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(statement), _Arcadia_Mil_VariableDefinitionStatementAst_getType(thread))) {
  ...
  )
{
  ...
  Arcadia_Value v = Arcadia_Map_get(Arcadia_Process_getThread(process), symbolTable, k);
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, definitionAst->procedureParameters); i < n; ++i) {
    ...
    Arcadia_String* variableNameString = R_Argument_getObjectReferenceValue(thread, &variableNameValue, _Arcadia_String_getType(thread));
  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, classBodyAst); i < n; ++i) {
    ...
    if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(element), _Arcadia_Mil_ConstructorDefinitionAst_getType(thread))) {
      onConstructorDefinition(process, interpreterProcessState, symbolTable, foreignProcedures, enclosing, element);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(element), _Arcadia_Mil_MethodDefinitionAst_getType(thread))) {
      onMethodDefinition(process, interpreterProcessState, symbolTable, foreignProcedures, enclosing, element);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(element), _Arcadia_Mil_VariableDefinitionAst_getType(thread))) {
  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_Mil_ModuleAst_getNumberOfDefinitions(thread, moduleAst); i < n; ++i) {
    ...
    if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(definitionAst), _Arcadia_Mil_ClassDefinitionAst_getType(thread))) {
      onClassDefinition(thread, interpreterProcess, symbolTable, foreignProcedures, (Arcadia_Mil_ClassDefinitionAst*)definitionAst);
    } else if (Arcadia_Type_isSubType(thread, Arcadia_Object_getType(definitionAst), _Arcadia_Mil_ProcedureDefinitionAst_getType(thread))) {
