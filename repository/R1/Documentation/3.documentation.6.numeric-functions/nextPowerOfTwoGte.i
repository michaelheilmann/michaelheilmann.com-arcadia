<h4 id="r-nextpoweroftwogte">R_nextPowerOfTwoGte</h4>
<p>R provides functions returning the next power of two greater or equal to a value.</p>
<p><code>
<my-mv>Type</my-mv> R_nextPowerOfTwoGte<my-mv>Suffix</my-mv>(<my-mv>Type</my-mv> x)
</code></p>
...
<h5><b>Errors</b></h5>
<table>
  <tr><td>R_Status_NotExists</td><td>The next power of two greater greater than or equal to <code>x</code> is not representable by the type <my-mv>Type</my-mv></td></tr>
</table>
