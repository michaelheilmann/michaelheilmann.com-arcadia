  ...
  )
{
  ...
  for (R_SizeValue i = 0, n = numberOfCodePoints; i < n; ++i) {
    ...
    if (codePoint <= 0x7f) {
      ...
      (*callbackFunction)(callbackContext, &x[0], R_SizeValue_Literal(1));
      ...
      // OR in 1000.0000.
      x[1] |= 0b10000000;
      (*callbackFunction)(callbackContext, &x[0], R_SizeValue_Literal(2));
      ...
      x[1] |= 0b10000000;
      x[2] |= 0b10000000;
      (*callbackFunction)(callbackContext, &x[0], R_SizeValue_Literal(3));
      ...
      x[2] |= 0b10000000;
      x[3] |= 0b10000000;
      (*callbackFunction)(callbackContext, &x[0], R_SizeValue_Literal(4));
    } else {
