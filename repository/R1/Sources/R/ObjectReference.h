...
#define R_ObjectReferenceValue_NumberOfBytes (sizeof(void*))
  ...
  static_assert(R_ObjectReferenceValue_NumberOfBytes == 8, "R.ObjectReferenceValue.NumberOfBytes must be 8");
#elif R_Configuration_InstructionSetArchitecture == R_Configuration_InstructionSetArchitecture_X86
  static_assert(R_ObjectReferenceValue_NumberOfBytes == 4, "R.ObjectReferenceValue.NumberOfBytes must be 4");
#else
