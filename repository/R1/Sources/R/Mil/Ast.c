...
static const R_ObjectType_Operations _R_Mil_NumberLiteralOperandAst_objectTypeOperations = {
  .construct = &R_Mil_NumberLiteralOperandAst_constructImpl,
  .destruct = NULL,
...
{
  R_Value argumentValues[] = { {.tag = R_ValueTag_ObjectReference, .objectReferenceValue = (R_ObjectReferenceValue)value } };
  R_Mil_NumberLiteralOperandAst* self = R_allocateObject(_R_Mil_NumberLiteralOperandAst_getType(), 1, &argumentValues[0]);
  return self;
}
