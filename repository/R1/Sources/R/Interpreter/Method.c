...
Rex_defineObjectType("R.Interpreter.Method", R_Interpreter_Method, "R.Object", R_Object, &_typeOperations);
  ...
  )
{
  ...
  R_Type* _type = _R_Interpreter_Method_getType();
  {
  ...
  )
{
  ...
  R_Interpreter_Method* self = R_allocateObject(_R_Interpreter_Method_getType(), 2, &argumentValues[0]);
  return self;
}
