...
{
  static_assert(R_SizeValue_Minimum >= R_SizeValue_Literal(0));
  if (R_Value_isSizeValue(other)) {
    ...
    static_assert(R_SizeValue_Maximum >= R_Natural8Value_Maximum, "environment not (yet) supported");
    ...
    static_assert(R_SizeValue_Maximum >= R_Natural16Value_Maximum, "environment not (yet) supported");
    ...
    static_assert(R_SizeValue_Maximum >= R_Natural32Value_Maximum, "environment not (yet) supported");
