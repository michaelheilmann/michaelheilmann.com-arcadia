...
#if !defined(ARCADIA_INTEGER32VALUE_H_INCLUDED)
#define ARCADIA_INTEGER32VALUE_H_INCLUDED
...
static_assert(R_Integer32Value_NumberOfBytes == 4, "R.Integer32Value.NumberOfBytes must be 4");

#define R_Integer32Value_NumberOfBits (R_Integer32Value_NumberOfBytes * 8)

#endif // ARCADIA_INTEGER32VALUE_H_INCLUDED
