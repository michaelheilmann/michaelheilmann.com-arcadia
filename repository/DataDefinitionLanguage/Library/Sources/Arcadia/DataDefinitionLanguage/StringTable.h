...
#if !defined(ARCADIA_DATADEFINITIONLANGUAGE_STRINGTABLE_H_INCLUDED)
#define ARCADIA_DATADEFINITIONLANGUAGE_STRINGTABLE_H_INCLUDED
...
#endif // ARCADIA_DATADEFINITIONLANGUAGE_STRINGTABLE_H_INCLUDED
