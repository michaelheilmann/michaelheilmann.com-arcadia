...
#if !defined(ARCADIA_MIL_FRONTEND_ASTS_REALLITERALOPERANDAST_H_INCLUDED)
#define ARCADIA_MIL_FRONTEND_ASTS_REALLITERALOPERANDAST_H_INCLUDED
...
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.Mil.RealLiteralOperandAst", Arcadia_Mil_RealLiteralOperandAst, u8"Arcadia.Mil.OperandAst");
...
#endif // ARCADIA_MIL_FRONTEND_ASTS_REALLITERALOPERANDAST_H_INCLUDED
