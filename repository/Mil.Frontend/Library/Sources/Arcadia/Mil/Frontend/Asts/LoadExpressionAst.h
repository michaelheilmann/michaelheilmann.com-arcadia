...
#if !defined(ARCADIA_MIL_FRONTEND_ASTS_LOADEXPRESSIONAST_H_INCLUDED)
#define ARCADIA_MIL_FRONTEND_ASTS_LOADEXPRESSIONAST_H_INCLUDED
...
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.Mil.LoadExpressionAst", Arcadia_Mil_LoadExpressionAst, u8"Arcadia.Mil.ExpressionAst");
...
#endif // ARCADIA_MIL_FRONTEND_ASTS_LOADEXPRESSIONAST_H_INCLUDED
