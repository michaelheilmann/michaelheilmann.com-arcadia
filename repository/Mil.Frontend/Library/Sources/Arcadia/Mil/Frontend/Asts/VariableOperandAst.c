...
Arcadia_defineObjectType(u8"Arcadia.Mil.VariableOperandAst", Arcadia_Mil_VariableOperandAst, u8"Arcadia.Mil.OperandAst", Arcadia_Mil_OperandAst, &_Arcadia_Mil_VariableOperandAst_typeOperations);
