...
#if !defined(ARCADIA_MIL_FRONTEND_ASTS_LABELSTATEMENTAST_H_INCLUDED)
#define ARCADIA_MIL_FRONTEND_ASTS_LABELSTATEMENTAST_H_INCLUDED
...
/// name ':'
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.Mil.LabelStatementAst", Arcadia_Mil_LabelStatementAst, u8"Arcadia.Mil.StatementAst");
...
#endif // ARCADIA_MIL_FRONTEND_ASTS_LABELSTATEMENTAST_H_INCLUDED
