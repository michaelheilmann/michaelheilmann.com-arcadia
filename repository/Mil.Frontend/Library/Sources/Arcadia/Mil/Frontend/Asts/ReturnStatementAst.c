...
#include "Arcadia/Mil/Frontend/Asts/ReturnStatementAst.h"
...
Arcadia_defineObjectType(u8"Arcadia.Mil.ReturnStatementAst", Arcadia_Mil_ReturnStatementAst, u8"Arcadia.Mil.StatementAst", Arcadia_Mil_StatementAst, &_Arcadia_Mil_ReturnStatementAst_typeOperations);
