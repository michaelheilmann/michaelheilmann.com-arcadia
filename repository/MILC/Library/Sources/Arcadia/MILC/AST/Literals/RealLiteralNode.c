...
static void
Arcadia_MILC_AST_RealLiteralNode_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_AST_RealLiteralNode* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_MILC_AST_RealLiteralNode_objectTypeOperations = {
  ...
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MILC_AST_RealLiteralNode_visitImpl,
};
...
{
  _Arcadia_BeginCreate(Arcadia_MILC_AST_RealLiteralNode);
  if (value) {
  ...
  _Arcadia_EndCreate(Arcadia_MILC_AST_RealLiteralNode);
}
