...
#include "Arcadia/MILC/Types/Type.h"
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_TypeDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Type", Arcadia_MILC_Type,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Type);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Type);
}
