...
#if !defined(ARCADIA_MILC_MEMBERENTERPHASE_CLASSCOMPLETER_H_INCLUDED)
#define ARCADIA_MILC_MEMBERENTERPHASE_CLASSCOMPLETER_H_INCLUDED
...
struct Arcadia_MILC_MemberEnterPhase_ClassCompleterDispatch {
  Arcadia_MILC_CompleterDispatch _parent;
};

struct Arcadia_MILC_MemberEnterPhase_ClassCompleter {
...
#endif // ARCADIA_MILC_MEMBERENTERPHASE_CLASSCOMPLETER_H_INCLUDED
