...
static void
Arcadia_MILC_ConstructorSymbol_constructImpl
  (
...
static void
Arcadia_MILC_ConstructorSymbol_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_ConstructorSymbolDispatch* self
  );

static void
Arcadia_MILC_ConstructorSymbol_destructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_ConstructorSymbol* self
  );
...
static void
Arcadia_MILC_ConstructorSymbol_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_ConstructorSymbol* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.ConstructorSymbol", Arcadia_MILC_ConstructorSymbol,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_ConstructorSymbol);
  ...
  //
  {
    ...
    Arcadia_ValueStack_pushEnumerationValue(thread, Arcadia_EnumerationValue_make(_Arcadia_MILC_SymbolKind_getType(thread), Arcadia_MILC_SymbolKind_Constructor));
...
{
  _Arcadia_BeginCreate(Arcadia_MILC_ConstructorSymbol);
  Arcadia_ValueStack_pushObjectReferenceValue(thread, (Arcadia_Object*)name);
  Arcadia_ValueStack_pushNatural8Value(thread, 1);
  _Arcadia_EndCreate(Arcadia_MILC_ConstructorSymbol);
}
