...
#if !defined(ARCADIA_MILC_DIAGNOSTICS_UNEXPECTEDWORDDIAGNOSTIC_H_INCLUDED)
#define ARCADIA_MILC_DIAGNOSTICS_UNEXPECTEDWORDDIAGNOSTIC_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.MILC.Diagnostics.UnexpectedWordDiagnostic", Arcadia_MILC_Diagnostics_UnexpectedWordDiagnostic,
                          u8"Arcadia.Languages.Diagnostic");

struct Arcadia_MILC_Diagnostics_UnexpectedWordDiagnosticDispatch {
  Arcadia_Languages_DiagnosticDispatch _parent;
};

struct Arcadia_MILC_Diagnostics_UnexpectedWordDiagnostic {
...
#endif // ARCADIA_MILC_DIAGNOSTICS_UNEXPECTEDWORDDIAGNOSTIC_H_INCLUDED
