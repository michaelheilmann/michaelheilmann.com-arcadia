...
constructImpl
  (
    ...
    Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnosticDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Diagnostics.SymbolAlreadyDefinedDiagnostic", Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic);
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic);
}
...
{ 
  _Arcadia_BeginCreate(Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic);
  ...
  _Arcadia_EndCreate(Arcadia_MILC_Diagnostics_SymbolAlreadyDefinedDiagnostic);
}
