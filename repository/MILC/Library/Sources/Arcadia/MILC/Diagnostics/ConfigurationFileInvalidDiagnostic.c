...
constructImpl
  (
    ...
    Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnosticDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Diagnostics.ConfigurationFileInvalidDiagnostic", Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic);
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic);
}
  ...
  )
{
  ...
  Arcadia_StringBuilder_insertBackCxxString(thread, stringBuffer, u8"error: configuration file `");
...
{ 
  _Arcadia_BeginCreate(Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic);
  ...
  _Arcadia_EndCreate(Arcadia_MILC_Diagnostics_ConfigurationFileInvalidDiagnostic);
}
