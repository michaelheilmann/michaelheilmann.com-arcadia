...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_InstructionNode_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.MIL.AST.InstructionNode", Arcadia_MIL_AST_InstructionNode,
                         u8"Arcadia.MIL.AST.InstructionStatementNode", Arcadia_MIL_AST_InstructionStatementNode,
                         &_typeOperations);
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_InstructionNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_InstructionNode);
}
