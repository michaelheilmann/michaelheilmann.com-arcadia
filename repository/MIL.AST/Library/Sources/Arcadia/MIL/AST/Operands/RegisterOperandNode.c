...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_RegisterOperandNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_RegisterOperandNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_RegisterOperandNode);
}
