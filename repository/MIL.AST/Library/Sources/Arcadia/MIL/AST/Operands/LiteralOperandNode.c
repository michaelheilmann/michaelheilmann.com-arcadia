...
static void
Arcadia_MIL_AST_LiteralOperandNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
...
static const Arcadia_ObjectType_Operations _Arcadia_MIL_AST_LiteralOperandNode_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_MIL_AST_LiteralOperandNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MIL_AST_LiteralOperandNode_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_LiteralOperandNode_initializeDispatchImpl,
};
