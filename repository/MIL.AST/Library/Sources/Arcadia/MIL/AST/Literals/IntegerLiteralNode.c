...
static const Arcadia_ObjectType_Operations _Arcadia_MIL_AST_IntegerLiteralNode_objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_IntegerLiteralNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_IntegerLiteralNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_IntegerLiteralNode);
}
