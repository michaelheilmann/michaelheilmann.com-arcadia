...
static void
Arcadia_MIL_AST_VoidLiteralNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MIL_AST_VoidLiteralNodeDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_MIL_AST_VoidLiteralNode_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_MIL_AST_VoidLiteralNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MIL_AST_VoidLiteralNode_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_VoidLiteralNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_VoidLiteralNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_VoidLiteralNode);
}
