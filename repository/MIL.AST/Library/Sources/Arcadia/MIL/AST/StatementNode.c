...
static void
Arcadia_MIL_AST_StatementNode_constructImpl
  (
...
static const Arcadia_ObjectType_Operations _Arcadia_MIL_AST_StatementNode_objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_StatementNode_initializeDispatchImpl,
};

static const Arcadia_Type_Operations _Arcadia_MIL_AST_StatementNode_typeOperations = {
  Arcadia_Type_Operations_Initializer,
  .objectTypeOperations = &_Arcadia_MIL_AST_StatementNode_objectTypeOperations,
};

Arcadia_defineObjectType(u8"Arcadia.MIL.AST.StatementNode", Arcadia_MIL_AST_StatementNode,
                         u8"Arcadia.MIL.AST.Node", Arcadia_MIL_AST_Node,
                         &_Arcadia_MIL_AST_StatementNode_typeOperations);
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_StatementNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_StatementNode);
}
