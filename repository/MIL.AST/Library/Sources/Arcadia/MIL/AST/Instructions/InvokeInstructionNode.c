...
/// @endcode
static void
Arcadia_MIL_AST_InvokeInstructionNode_constructImpl
  (
...
static void
Arcadia_MIL_AST_InvokeInstructionNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_MIL_AST_InvokeInstructionNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MIL_AST_InvokeInstructionNode_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_InvokeInstructionNode_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.MIL.AST.InvokeInstructionNode", Arcadia_MIL_AST_InvokeInstructionNode,
...
Arcadia_MIL_AST_InvokeInstructionNode*
Arcadia_MIL_AST_InvokeInstructionNode_create
  (
    Arcadia_Thread* thread,
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_AST_InvokeInstructionNode);
}
