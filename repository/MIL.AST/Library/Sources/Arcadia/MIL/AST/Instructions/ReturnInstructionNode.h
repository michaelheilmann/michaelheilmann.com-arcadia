...
#if !defined(ARCADIA_MIL_AST_RETURNINSTRUCTIONNODE_H_INCLUDED)
#define ARCADIA_MIL_AST_RETURNINSTRUCTIONNODE_H_INCLUDED

#include "Arcadia/MIL/AST/InstructionNode.h"
typedef struct Arcadia_MIL_AST_OperandNode Arcadia_MIL_AST_OperandNode;

/// @code
/// class Arcadia.MIL.AST.ReturnInstructionNode extends Arcadia.MIL.AST.InstructionNode
/// @endcode
/// Represents
/// @code
...
#endif // ARCADIA_MIL_AST_RETURNINSTRUCTIONNODE_H_INCLUDED
