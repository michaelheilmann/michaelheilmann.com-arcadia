...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_MIL_AST_EnumerationDefinitionNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MIL_AST_EnumerationDefinitionNode_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_EnumerationDefinitionNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_EnumerationDefinitionNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_EnumerationDefinitionNode);
}
