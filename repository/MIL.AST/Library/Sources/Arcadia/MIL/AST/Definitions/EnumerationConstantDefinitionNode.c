...
static void
Arcadia_MIL_AST_EnumerationConstantDefinitionNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MIL_AST_EnumerationConstantDefinitionNodeDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_MIL_AST_EnumerationConstantDefinitionNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MIL_AST_EnumerationConstantDefinitionNode_visit,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_EnumerationConstantDefinitionNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_EnumerationConstantDefinitionNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_EnumerationConstantDefinitionNode);
}
