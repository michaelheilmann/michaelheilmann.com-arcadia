...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_MIL_AST_ClassDefinitionNode_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_MIL_AST_ClassDefinitionNode);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_MIL_AST_ClassDefinitionNode);
}
