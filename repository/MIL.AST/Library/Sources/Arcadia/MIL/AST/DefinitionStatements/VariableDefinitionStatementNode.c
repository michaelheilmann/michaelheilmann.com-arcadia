...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_MIL_VariableDefinitionStatementNode_constructImpl,
  .destruct = NULL,
  .visit = &Arcadia_MIL_VariableDefinitionStatementNode_visit,
};
