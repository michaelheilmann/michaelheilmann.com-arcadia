...
/// @{
/// @brief Assign this matrix the values of a rotation transformation matrix representing a counter-clockwise rotation around the x-axis by the specified number of degrees.
