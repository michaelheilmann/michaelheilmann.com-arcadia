...
#if !defined(ARCADIA_MILC_AST_OPERANDS_OPERANDNODE_H_INCLUDED)
#define ARCADIA_MILC_AST_OPERANDS_OPERANDNODE_H_INCLUDED

#include "Arcadia/MILC/AST/Node.h"

/// @code
/// class Arcadia.MILC.AST.OperandNode extends Arcadia.MILC.AST.Node {
///   ...
/// }
/// @endcode
/// represents
...
struct Arcadia_MILC_AST_OperandNodeDispatch {
  Arcadia_MILC_AST_NodeDispatch _parent;
};

struct Arcadia_MILC_AST_OperandNode {
  Arcadia_MILC_AST_Node _parent;
};

#endif // ARCADIA_MILC_AST_OPERANDS_OPERANDNODE_H_INCLUDED
