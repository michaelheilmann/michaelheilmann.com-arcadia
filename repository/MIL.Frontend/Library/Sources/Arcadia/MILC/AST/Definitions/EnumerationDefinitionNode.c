...
static void
Arcadia_MILC_AST_EnumerationDefinitionNode_visit
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_AST_EnumerationDefinitionNode* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MILC_AST_EnumerationDefinitionNode_visit,
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MILC_AST_EnumerationDefinitionNode);
}
