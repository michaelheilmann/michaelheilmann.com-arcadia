...
static void
Arcadia_MILC_AST_VoidLiteralNode_visit
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_AST_VoidLiteralNode* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_MILC_AST_VoidLiteralNode_objectTypeOperations = {
  ...
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_MILC_AST_VoidLiteralNode_visit,
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MILC_AST_VoidLiteralNode);
}
