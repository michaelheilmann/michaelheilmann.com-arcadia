...
#if !defined(ARCADIA_MILC_AST_REALLITERALNODE_H_INCLUDED)
#define ARCADIA_MILC_AST_REALLITERALNODE_H_INCLUDED
...
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.MILC.AST.RealLiteralNode", Arcadia_MILC_AST_RealLiteralNode,
                          u8"Arcadia.MILC.AST.Node");

struct Arcadia_MILC_AST_RealLiteralNodeDispatch {
  Arcadia_MILC_AST_NodeDispatch parent;
};

struct Arcadia_MILC_AST_RealLiteralNode {
...
#endif // ARCADIA_MILC_AST_REALLITERALNODE_H_INCLUDED
