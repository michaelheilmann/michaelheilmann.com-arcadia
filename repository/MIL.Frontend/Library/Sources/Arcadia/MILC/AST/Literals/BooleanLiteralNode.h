...
#if !defined(ARCADIA_MILC_AST_BOOLEANLITERALNODE_H_INCLUDED)
...
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.MILC.AST.BooleanLiteralNode", Arcadia_MILC_AST_BooleanLiteralNode,
                          u8"Arcadia.MILC.AST.Node");

struct Arcadia_MILC_AST_BooleanLiteralNodeDispatch {
  Arcadia_MILC_AST_NodeDispatch parent;
};

struct Arcadia_MILC_AST_BooleanLiteralNode {
...
#endif // ARCADIA_MILC_AST_BOOLEANLITERALNODE_H_INCLUDED
