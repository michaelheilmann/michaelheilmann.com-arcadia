  ...
  )
{
  ...
  Arcadia_StringBuilder_insertBackCxxString(thread, stringBuffer, u8"` has multiple module definitions\n");
...
{ 
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MILC_Diagnostics_MultipleModuleDefinitionsDiagnostic);
}
