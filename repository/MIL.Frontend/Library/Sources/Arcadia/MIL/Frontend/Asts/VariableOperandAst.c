...
#include "Arcadia/MIL/Frontend/Asts/VariableOperandAst.h"
...
Arcadia_defineObjectType(u8"Arcadia.MIL.VariableOperandAst", Arcadia_MIL_VariableOperandAst,
                         u8"Arcadia.MIL.OperandAst", Arcadia_MIL_OperandAst,
                         &_Arcadia_MIL_VariableOperandAst_typeOperations);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_VariableOperandAst);
}
