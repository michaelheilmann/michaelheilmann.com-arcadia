...
Arcadia_defineObjectType(u8"Arcadia.MIL.RealLiteralOperandAst", Arcadia_MIL_RealLiteralOperandAst,
                         u8"Arcadia.MIL.OperandAst", Arcadia_MIL_OperandAst,
                         &_Arcadia_MIL_RealLiteralOperandAst_typeOperations);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_RealLiteralOperandAst);
}
