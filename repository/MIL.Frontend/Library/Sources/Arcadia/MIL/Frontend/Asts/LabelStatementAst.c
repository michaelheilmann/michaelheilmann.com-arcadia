...
Arcadia_defineObjectType(u8"Arcadia.MIL.LabelStatementAst", Arcadia_MIL_LabelStatementAst,
                         u8"Arcadia.MIL.StatementAst", Arcadia_MIL_StatementAst,
                         &_Arcadia_MIL_LabelStatementAst_typeOperations);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_LabelStatementAst);
}
