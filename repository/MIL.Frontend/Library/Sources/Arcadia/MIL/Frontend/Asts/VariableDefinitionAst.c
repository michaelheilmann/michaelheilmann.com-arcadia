...
Arcadia_defineObjectType(u8"Arcadia.MIL.VariableDefinitionAst", Arcadia_MIL_VariableDefinitionAst,
                         u8"Arcadia.MIL.Ast", Arcadia_MIL_Ast,
                         &_Arcadia_MIL_VariableDefinitionAst_typeOperations);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_VariableDefinitionAst);
}
