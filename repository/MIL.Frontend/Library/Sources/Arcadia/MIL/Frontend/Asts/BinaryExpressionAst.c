...
Arcadia_defineObjectType(u8"Arcadia.MIL.BinaryExpressionAst", Arcadia_MIL_BinaryExpressionAst,
                         u8"Arcadia.MIL.ExpressionAst", Arcadia_MIL_ExpressionAst,
                         &_Arcadia_MIL_BinaryExpressionAst_typeOperations);
  ...
  )
{
  ...
  _self->type = Arcadia_ValueStack_getInteger32Value(thread, 3);
  _self->operand1 = (Arcadia_MIL_OperandAst*)Arcadia_ValueStack_getObjectReferenceValueChecked(thread, 2, _Arcadia_MIL_OperandAst_getType(thread));
  _self->operand2 = (Arcadia_MIL_OperandAst*)Arcadia_ValueStack_getObjectReferenceValueChecked(thread, 1, _Arcadia_MIL_OperandAst_getType(thread));
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_BinaryExpressionAst);
}
