...
Arcadia_defineObjectType(u8"Arcadia.MIL.StringLiteralOperandAst", Arcadia_MIL_StringLiteralOperandAst,
                         u8"Arcadia.MIL.OperandAst", Arcadia_MIL_OperandAst,
                         &_Arcadia_MIL_StringLiteralOperandAst_typeOperations);
