...
#if !defined(ARCADIA_MIL_FRONTEND_ASTS_MODULEAST_H_INCLUDED)
#define ARCADIA_MIL_FRONTEND_ASTS_MODULEAST_H_INCLUDED
...
#endif // ARCADIA_MIL_FRONTEND_ASTS_MODULEAST_H_INCLUDED
