...
Arcadia_defineObjectType(u8"Arcadia.MIL.VoidLiteralOperandAst", Arcadia_MIL_VoidLiteralOperandAst,
                         u8"Arcadia.MIL.OperandAst", Arcadia_MIL_OperandAst,
                         &_Arcadia_MIL_VoidLiteralOperandAst_typeOperations);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_MIL_VoidLiteralOperandAst);
}
