...
static const Arcadia_ObjectType_Operations _Arcadia_MIL_RaiseStatementAst_objectTypeOperations = {
  .construct = (Arcadia_Object_ConstructorCallbackFunction*) & Arcadia_MIL_RaiseStatementAst_constructImpl,
  .destruct = NULL,
...
Arcadia_defineObjectType(u8"Arcadia.MIL.RaiseStatementAst", Arcadia_MIL_RaiseStatementAst,
                         u8"Arcadia.MIL.AST.StatementNode", Arcadia_MIL_AST_StatementNode,
                         &_Arcadia_MIL_RaiseStatementAst_typeOperations);
  ...
  )
{
  ...
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  ARCADIA_CREATEOBJECT(Arcadia_MIL_RaiseStatementAst);
}
