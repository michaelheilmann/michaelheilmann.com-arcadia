...
#if !defined(ARCADIA_MIL_AST_LOADEXPRESSIONAST_H_INCLUDED)
#define ARCADIA_MIL_AST_LOADEXPRESSIONAST_H_INCLUDED
...
/// @endcode
Arcadia_declareObjectType(u8"Arcadia.MIL.LoadExpressionAst", Arcadia_MIL_LoadExpressionAst,
...
#endif // ARCADIA_MIL_AST_LOADEXPRESSIONAST_H_INCLUDED
