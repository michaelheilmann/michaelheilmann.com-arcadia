...
#if !defined(MODULE_VISUALS_WINDOWS_TEMPORARYWINDOW_H_INCLUDED)
#define MODULE_VISUALS_WINDOWS_TEMPORARYWINDOW_H_INCLUDED
...
#endif // MODULE_VISUALS_WINDOWS_TEMPORARYWINDOW_H_INCLUDED
