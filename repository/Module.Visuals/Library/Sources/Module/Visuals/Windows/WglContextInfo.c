...
#include "Module/Visuals/Windows/WglContextInfo.h"
...
static void
Arcadia_Visuals_Windows_WglContextInfo_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Value* self,
...
static void
Arcadia_Visuals_Windows_WglContextInfo_destruct
  (
    Arcadia_Thread* thread,
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Visuals_Windows_WglContextInfo_constructImpl,
  .destruct = &Arcadia_Visuals_Windows_WglContextInfo_destruct,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Windows.WglContextInfo", Arcadia_Visuals_Windows_WglContextInfo, u8"Arcadia.Object", Arcadia_Object, &_typeOperations);
...
{
  Arcadia_Visuals_Windows_WglContextInfo* _self = Arcadia_Value_getObjectReferenceValue(self);
  Arcadia_TypeValue _type = _Arcadia_Visuals_Windows_WglContextInfo_getType(thread);
  {
...
{
  Arcadia_Value argumentValues[] = { {.tag = Arcadia_ValueTag_Void, .voidValue = Arcadia_VoidValue_Void } };
  Arcadia_Visuals_Windows_WglContextInfo* self = Arcadia_allocateObject(thread, _Arcadia_Visuals_Windows_WglContextInfo_getType(thread), 0, &argumentValues[0]);
  return self;
}
...
Arcadia_Visuals_Windows_WglContextInfo_isVersionSupported
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Windows_WglContextInfo* self,
    Arcadia_Natural8Value majorVersion,
