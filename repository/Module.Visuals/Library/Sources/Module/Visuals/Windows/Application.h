...
#if !defined(MODULE_VISUALS_WINDOWS_APPLICATION_H_INCLUDED)
#define MODULE_VISUALS_WINDOWS_APPLICATION_H_INCLUDED
...
#endif // MODULE_VISUALS_WINDOWS_APPLICATION_H_INCLUDED
