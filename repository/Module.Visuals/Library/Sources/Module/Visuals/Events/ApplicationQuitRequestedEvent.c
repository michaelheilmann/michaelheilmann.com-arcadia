...
#include "Module/Visuals/Events/ApplicationQuitRequestedEvent.h"
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.ApplicationQuitRequestedEvent", Arcadia_Visuals_ApplicationQuitRequestedEvent, u8"Arcadia.Visuals.ApplicationEvent", Arcadia_Visuals_ApplicationEvent, &_typeOperations);
