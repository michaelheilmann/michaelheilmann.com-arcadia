...
#if !defined(MODULE_VISUALS_CANVASACTIVATIONSTATECHANGEDEVENT_H_INCLUDED)
#define MODULE_VISUALS_CANVASACTIVATIONSTATECHANGEDEVENT_H_INCLUDED
...
#endif // MODULE_VISUALS_CANVASACTIVATIONSTATECHANGEDEVENT_H_INCLUDED
