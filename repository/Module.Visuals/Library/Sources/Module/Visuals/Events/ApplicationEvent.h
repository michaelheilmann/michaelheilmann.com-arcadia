...
#if !defined(ARCADIA_VISUALS_APPLICATIONEVENT_H_INCLUDED)
#define ARCADIA_VISUALS_APPLICATIONEVENT_H_INCLUDED
...
#endif // ARCADIA_VISUALS_APPLICATIONEVENT_H_INCLUDED
