  ...
  )
{
  ...
  ((ImageWriter*)_self)->writeBmpToByteBuffer = (void (*)(Arcadia_Thread*, ImageWriter*, PixelBuffer*,Arcadia_ByteBuffer*))LibPngImageWriter_writeBmpToByteBufferImpl;
  ((ImageWriter*)_self)->writeBmpToPath = (void (*)(Arcadia_Thread*, ImageWriter*, PixelBuffer*, Arcadia_String*))LibPngImageWriter_writeBmpToPathImpl;
  ...
  ((ImageWriter*)_self)->writePngToByteBuffer = (void (*)(Arcadia_Thread*, ImageWriter*, PixelBuffer*, Arcadia_ByteBuffer*))LibPngImageWriter_writePngToByteBufferImpl;
  ((ImageWriter*)_self)->writePngToPath = (void (*)(Arcadia_Thread*, ImageWriter*, PixelBuffer*, Arcadia_String*))LibPngImageWriter_writePngToPathImpl;
