...
static void
Linux_NativeIcon_constructImpl
  (
...
static void
Linux_NativeIcon_destruct
  (
    Arcadia_Thread* thread,
    Linux_NativeIcon* self
  );

static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Linux_NativeIcon_constructImpl,
  .destruct = &Linux_NativeIcon_destruct,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Linux.NativeIcon", Linux_NativeIcon, u8"NativeIcon", NativeIcon, &_typeOperations);
...
{
  Linux_NativeIcon* _self = Arcadia_Value_getObjectReferenceValue(self);
  Arcadia_TypeValue _type = _Linux_NativeIcon_getType(thread);
  {
  ...
  )
{
  ...
  Linux_NativeIcon* self = Arcadia_allocateObject(thread, _Linux_NativeIcon_getType(thread), 6, &argumentValues[0]);
  return self;
}
