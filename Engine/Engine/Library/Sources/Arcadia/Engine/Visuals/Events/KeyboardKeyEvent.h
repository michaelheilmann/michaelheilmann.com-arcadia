...
#include "Arcadia/Engine/Visuals/Events/KeyboardKey.h"
#include "Arcadia/Engine/Visuals/Events/KeyboardKeyAction.h"
typedef struct Arcadia_Engine_Visuals_Window Arcadia_Engine_Visuals_Window;

// https://michaelheilmann.com/Arcadia/Engine/#Arcadia_Visuals_KeyboardKeyEvent
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.KeyboardKeyEvent", Arcadia_Visuals_KeyboardKeyEvent,
