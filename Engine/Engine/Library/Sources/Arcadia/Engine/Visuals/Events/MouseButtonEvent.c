...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Visuals_MouseButtonEvent_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Visuals.MouseButtonEvent", Arcadia_Visuals_MouseButtonEvent,
