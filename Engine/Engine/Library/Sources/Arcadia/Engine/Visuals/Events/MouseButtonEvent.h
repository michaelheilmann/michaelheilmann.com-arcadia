...
#include "Arcadia/Engine/Visuals/Events/MouseButtonAction.h"
typedef struct Arcadia_Engine_Visuals_Window Arcadia_Engine_Visuals_Window;

// https://michaelheilmann.com/Arcadia/Engine/#Arcadia_Visuals_MouseButtonEvent
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.MouseButtonEvent", Arcadia_Visuals_MouseButtonEvent,
