...
// https://michaelheilmann.com/Arcadia/Engine/#Arcadia_Visuals_MousePointerAction
Arcadia_declareEnumerationType(u8"Arcadia.Engine.Visuals.MousePointerAction", Arcadia_Visuals_MousePointerAction);
