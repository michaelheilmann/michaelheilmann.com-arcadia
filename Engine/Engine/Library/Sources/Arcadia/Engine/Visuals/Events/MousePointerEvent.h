...
#include "Arcadia/Engine/Visuals/Events/MousePointerAction.h"
typedef struct Arcadia_Engine_Visuals_Window Arcadia_Engine_Visuals_Window;

// https://michaelheilmann.com/Arcadia/Engine/#Arcadia_Visuals_MousePointerEvent
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.MousePointerEvent", Arcadia_Visuals_MousePointerEvent,
