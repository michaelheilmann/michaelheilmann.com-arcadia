...
static void
Arcadia_Visuals_MousePointerEvent_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_MousePointerEventDispatch* self
  );

static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  Arcadia_ObjectType_Operations_Initializer,
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_MousePointerEvent_constructImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Visuals_MousePointerEvent_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Visuals.MousePointerEvent", Arcadia_Visuals_MousePointerEvent,
...
{
  Arcadia_EnterConstructor(Arcadia_Visuals_MousePointerEvent);
  ...
  //
  Arcadia_LeaveConstructor(Arcadia_Visuals_MousePointerEvent);
}
