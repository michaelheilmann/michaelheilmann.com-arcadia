...
static void
Arcadia_Visuals_VPL_Field_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_VPL_Field* self
  );

static void
Arcadia_Visuals_VPL_Field_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_VPL_FieldDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_VPL_Field_constructImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Visuals.VPL.Field", Arcadia_Visuals_VPL_Field,
...
{
  Arcadia_TypeValue _type = _Arcadia_Visuals_VPL_Field_getType(thread);
  {
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Visuals_VPL_Field);
}
