...
static void
Arcadia_Visuals_VPL_VariableScalar_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_VPL_VariableScalar* self
  );

static void
Arcadia_Visuals_VPL_VariableScalar_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_VPL_VariableScalarDispatch* self
  );

static void
Arcadia_Visuals_VPL_VariableScalar_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_VPL_VariableScalar* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_VPL_VariableScalar_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_Visuals_VPL_VariableScalar_visitImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Visuals.VPL.VariableScalar", Arcadia_Visuals_VPL_VariableScalar,
...
{
  Arcadia_TypeValue _type = _Arcadia_Visuals_VPL_VariableScalar_getType(thread);
  {
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Visuals_VPL_VariableScalar);
}
