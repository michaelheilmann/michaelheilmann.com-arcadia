...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Engine_BackendContext_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_Engine_BackendContext);
  {
