...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Engine_Audials_Backend_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Engine.Audials.Backend", Arcadia_Engine_Audials_Backend,
...
{
  Arcadia_EnterConstructor(Arcadia_Engine_Audials_Backend);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_Engine_Audials_Backend);
}
