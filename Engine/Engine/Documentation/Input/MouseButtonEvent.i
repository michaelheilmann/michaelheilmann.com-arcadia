...
<section class="cxx entity method">
  ...
  <my-signature><code>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;action : Arcadia.Engine.Input.MouseButtonAction,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;button : Arcadia.Natural64Value,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;x : Arcadia.Integer64Value,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;y : Arcadia.Integer64Value<br>
    &nbsp;&nbsp;)
  </code></my-signature>
  ...
  <section class="cxx parameters">
    ...
    <div>
      <div>action : Arcadia.Engine.Input.MouseButtonAction</div>
