...
#if !defined(ARCADIA_AUDIALS_NODES_SOUNDSOURCENODE_H_INCLUDED)
#define ARCADIA_AUDIALS_NODES_SOUNDSOURCENODE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.Audials.SoundSourceNode", Arcadia_Engine_Audials_SoundSourceNode,
                          u8"Arcadia.Audials.Node");
...
#endif // ARCADIA_AUDIALS_NODES_SOUNDSOURCENODE_H_INCLUDED
