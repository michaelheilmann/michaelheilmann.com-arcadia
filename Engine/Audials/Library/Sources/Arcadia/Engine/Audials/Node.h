...
#if !defined(ARCADIA_AUDIALS_NODE_H_INCLUDED)
#define ARCADIA_AUDIALS_NODE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.Audials.Node", Arcadia_Engine_Audials_Node,
...
#endif // ARCADIA_AUDIALS_NODE_H_INCLUDED
