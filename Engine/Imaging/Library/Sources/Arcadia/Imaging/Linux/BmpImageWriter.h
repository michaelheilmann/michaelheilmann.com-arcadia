...
#if !defined(ARCADIA_IMAGING_LINUX_BMPIMAGEWRITER_H_INCLUDED)
#define ARCADIA_IMAGING_LINUX_BMPIMAGEWRITER_H_INCLUDED
...
#endif // ARCADIA_IMAGING_LINUX_BMPIMAGEWRITER_H_INCLUDED
