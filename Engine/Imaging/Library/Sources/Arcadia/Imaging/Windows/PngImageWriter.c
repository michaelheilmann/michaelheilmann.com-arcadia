...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Imaging_Windows_PngImageWriter_constructImpl,
  .destruct = NULL,
  .visit = NULL,
};
...
{
  Arcadia_Imaging_Windows_PngImageWriter* _self = Arcadia_Value_getObjectReferenceValue(self);
  ...
  ((Arcadia_Imaging_ImageWriter*)_self)->getSupportedTypes = (Arcadia_ImmutableList * (*)(Arcadia_Thread*, Arcadia_Imaging_ImageWriter*))&Arcadia_Imaging_Windows_PngImageWriter_getSupportedTypes;
  ((Arcadia_Imaging_ImageWriter*)_self)->write = (void (*)(Arcadia_Thread*, Arcadia_Imaging_ImageWriter*, Arcadia_List*, Arcadia_Imaging_ImageWriterParameters*))&Arcadia_Imaging_Windows_PngImageWriter_write;
  ...
  )
{
  ...
  Arcadia_Imaging_Windows_PngImageWriter* self = Arcadia_allocateObject(thread, _Arcadia_Imaging_Windows_PngImageWriter_getType(thread), 0, &argumentValues[0]);
  return self;
}
