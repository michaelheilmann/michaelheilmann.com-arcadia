...
Arcadia_defineObjectType(u8"Arcadia.Visuals.WindowPositionChangedEvent", Arcadia_Engine_Visuals_WindowPositionChangedEvent,
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Engine_Visuals_WindowPositionChangedEvent);
}
