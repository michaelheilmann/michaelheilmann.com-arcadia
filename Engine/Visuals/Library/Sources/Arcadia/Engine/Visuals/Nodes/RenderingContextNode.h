...
#if !defined(ARCADIA_ENGINE_VISUALS_NODES_RENDERINGCONTEXTNODE_H_INCLUDED)
#define ARCADIA_ENGINE_VISUALS_NODES_RENDERINGCONTEXTNODE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.RenderingContextNode", Arcadia_Engine_Visuals_RenderingContextNode,
                          u8"Arcadia.Engine.Visuals.Node");

struct Arcadia_Engine_Visuals_RenderingContextNodeDispatch {
  Arcadia_Engine_Visuals_NodeDispatch parent;
};

struct Arcadia_Engine_Visuals_RenderingContextNode {
...
#endif // ARCADIA_ENGINE_VISUALS_NODES_RENDERINGCONTEXTNODE_H_INCLUDED
