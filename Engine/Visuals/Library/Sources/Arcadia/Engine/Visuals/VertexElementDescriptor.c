...
static void
Arcadia_Engine_Visuals_VertexElementDescriptor_construct
  (
...
static void
Arcadia_Engine_Visuals_VertexElementDescriptor_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
...
static void
Arcadia_Engine_Visuals_VertexElementDescriptor_isEqualTo
  (
    Arcadia_Thread* thread
  );

static void
Arcadia_Engine_Visuals_VertexElementDescriptor_isNotEqualTo
  (
    Arcadia_Thread* thread
  );
...
static const Arcadia_Type_Operations _Arcadia_Engine_Visuals_VertexElementDescriptor_typeOperations = {
  ...
  .objectTypeOperations = &_Arcadia_Engine_Visuals_VertexElementDescriptor_objectTypeOperations,
};

Arcadia_defineObjectType(u8"Arcardia.Engine.Visuals.VertexElementDescriptor", Arcadia_Engine_Visuals_VertexElementDescriptor,
                         u8"Arcadia.Object", Arcadia_Object,
                         &_Arcadia_Engine_Visuals_VertexElementDescriptor_typeOperations);
  ...
  )
{
  ...
  Arcadia_Engine_Visuals_VertexElementDescriptor* xx = (Arcadia_Engine_Visuals_VertexElementDescriptor*)Arcadia_Value_getObjectReferenceValueChecked(thread, x, _Arcadia_Engine_Visuals_VertexElementDescriptor_getType(thread));


  Arcadia_Value y = Arcadia_ValueStack_getValue(thread, 1);
  Arcadia_ValueStack_popValues(thread, 3);
  if (!Arcadia_Value_isInstanceOf(thread, &y, _Arcadia_Engine_Visuals_VertexElementDescriptor_getType(thread))) {
    Arcadia_ValueStack_pushBooleanValue(thread, Arcadia_BooleanValue_False);
  } else {
    Arcadia_Engine_Visuals_VertexElementDescriptor* yy = (Arcadia_Engine_Visuals_VertexElementDescriptor*)Arcadia_Value_getObjectReferenceValue(&y);
...
Arcadia_Engine_Visuals_VertexElementDescriptor*
Arcadia_Engine_Visuals_VertexElementDescriptor_create
  (
    Arcadia_Thread* thread,
    Arcadia_Natural8Value offset,
    Arcadia_Engine_Visuals_VertexElementSemantics semantics,
    Arcadia_Engine_Visuals_VertexElementSyntactics syntactics
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_Engine_Visuals_VertexElementDescriptor);
}
