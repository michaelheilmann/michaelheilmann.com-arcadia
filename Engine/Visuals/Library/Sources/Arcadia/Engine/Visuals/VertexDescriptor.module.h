...
#if !defined(ARCADIA_ENGINE_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED)
#define ARCADIA_ENGINE_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED
...
#endif // ARCADIA_ENGINE_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED
