...
static void
Arcadia_Visuals_WindowPositionChangedEvent_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_WindowPositionChangedEventDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_WindowPositionChangedEvent_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_Visuals_WindowPositionChangedEvent_visit,
};
