...
#define Arcadia_Visuals_VPL_VariableScalarFlags_Vertex (1)
...
#define Arcadia_Visuals_VPL_VariableScalarFlags_Fragment (2)
...
#define Arcadia_Visuals_VPL_VariableScalarFlags_FrameBuffer (3)
