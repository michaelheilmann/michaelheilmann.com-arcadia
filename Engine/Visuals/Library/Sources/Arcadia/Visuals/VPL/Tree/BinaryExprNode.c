...
Arcadia_defineObjectType(u8"Arcadia.Visuals.VPL.Tree.BinaryExprNode", Arcadia_Visuals_VPL_Tree_BinaryExprNode,
                         u8"Arcadia.Visuals.VPL.Tree.Node", Arcadia_Visuals_VPL_Tree_Node,
                         &_typeOperations);
