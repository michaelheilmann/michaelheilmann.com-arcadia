...
#if !defined(ARCADIA_VISUALS_CULLMODE_H_INCLUDED)
#define ARCADIA_VISUALS_CULLMODE_H_INCLUDED
...
// https://michaelheilmann.com/Arcadia/Visuals/#Arcadia_Visuals_CullMode
...
#endif // ARCADIA_VISUALS_CULLMODE_H_INCLUDED
