...
static void
Arcadia_Visuals_Scene_PixelBufferNode_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Scene_PixelBufferNode* self
  );

static void
Arcadia_Visuals_Scene_PixelBufferNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Scene_PixelBufferNodeDispatch* self
  );

static void
Arcadia_Visuals_Scene_PixelBufferNode_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Scene_PixelBufferNode* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Visuals_Scene_PixelBufferNode_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_Visuals_Scene_PixelBufferNode_visitImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Scene.PixelBufferNode", Arcadia_Visuals_Scene_PixelBufferNode,
...
{
  Arcadia_TypeValue _type = _Arcadia_Visuals_Scene_PixelBufferNode_getType(thread);
