...
static void
Arcadia_Visuals_Backend_constructImpl
  (
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  .construct = &Arcadia_Visuals_Backend_constructImpl,
  .destruct = NULL,
  .visit = NULL,
};
...
Arcadia_defineObjectType(u8"Arcadia.Visuals.Backend", Arcadia_Visuals_Backend,
...
{
  Arcadia_Visuals_Backend* _self = Arcadia_Value_getObjectReferenceValue(self);
  Arcadia_TypeValue _type = _Arcadia_Visuals_Backend_getType(thread);
  {
