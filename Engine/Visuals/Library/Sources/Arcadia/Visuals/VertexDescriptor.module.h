...
#if !defined(ARCADIA_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED)
#define ARCADIA_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED
...
#endif // ARCADIA_VISUALS_VERTEXDESCRIPTOR_MODULE_H_INCLUDED
