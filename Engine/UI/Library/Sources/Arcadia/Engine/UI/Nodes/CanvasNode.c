  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_Collection_getSize(thread, (Arcadia_Collection*)self->rectangles); i < n; ++i) {
    Arcadia_Engine_Visuals_ModelNode* modelNode = (Arcadia_Engine_Visuals_ModelNode*)Arcadia_List_getObjectReferenceValueCheckedAt(thread, self->rectangles, i, _Arcadia_Engine_Visuals_ModelNode_getType(thread));
