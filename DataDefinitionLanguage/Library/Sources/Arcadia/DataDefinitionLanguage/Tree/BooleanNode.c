...
static const Arcadia_ObjectType_Operations _Arcadia_DataDefinitionLanguage_Tree_BooleanNode_objectTypeOperations = {
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_DataDefinitionLanguage_Tree_BooleanNode_constructImpl,
  .destruct = NULL,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_DataDefinitionLanguage_Tree_BooleanNode_visit,
};
