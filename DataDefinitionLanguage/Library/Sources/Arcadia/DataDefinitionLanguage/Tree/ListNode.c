...
static const Arcadia_ObjectType_Operations _Arcadia_DataDefinitionLanguage_Tree_ListNode_objectTypeOperations = {
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_DataDefinitionLanguage_Tree_ListNode_constructImpl,
  .destruct = NULL,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_DataDefinitionLanguage_Tree_ListNode_visit,
};
  ...
  )
{
  ...
  {
    Arcadia_ValueStack_pushInteger32Value(thread, Arcadia_DataDefinitionLanguage_Tree_NodeType_List);
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_DataDefinitionLanguage_Tree_ListNode);
}
