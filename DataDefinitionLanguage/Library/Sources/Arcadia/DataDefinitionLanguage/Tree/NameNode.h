...
#if !defined(ARCADIA_DATADEFINITIONLANGUAGE_TREE_NAMENODE_H_INCLUDED)
#define ARCADIA_DATADEFINITIONLANGUAGE_TREE_NAMENODE_H_INCLUDED

#include "Arcadia/DataDefinitionLanguage/Tree/Node.h"
#include "Arcadia/Ring2/Include.h"

Arcadia_declareObjectType(u8"Arcadia.DataDefinitionLanguage.Tree.NameNode", Arcadia_DataDefinitionLanguage_Tree_NameNode, u8"Arcadia.DataDefinitionLanguage.Tree.Node");
