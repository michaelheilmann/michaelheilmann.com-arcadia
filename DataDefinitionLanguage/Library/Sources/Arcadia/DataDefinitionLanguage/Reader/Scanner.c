...
struct Arcadia_DataDefinitionLanguage_Scanner {
  ...
  // The string table.
  Arcadia_DataDefinitionLanguage_StringTable* stringTable;
  // The keywords.
...
static void
Arcadia_DataDefinitionLanguage_Scanner_destruct
  (
    Arcadia_Thread* thread,
    Arcadia_DataDefinitionLanguage_Scanner* self
  );
...
static void
Arcadia_DataDefinitionLanguage_Scanner_visit
  (
    Arcadia_Thread* thread,
    Arcadia_DataDefinitionLanguage_Scanner* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .destruct = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_DataDefinitionLanguage_Scanner_destruct,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_DataDefinitionLanguage_Scanner_visit,
};
...
Arcadia_defineObjectType(u8"Arcadia.DataDefinitionLanguage.Scanner", Arcadia_DataDefinitionLanguage_Scanner,
  ...
  )
{
  ...
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  ARCADIA_CREATEOBJECT(Arcadia_DataDefinitionLanguage_Scanner);
}
  ...
  )
{
  ...
  Arcadia_Integer32Value type = Arcadia_DataDefinitionLanguage_WordType_IntegerLiteral;
  if (isDecimalDigit(thread, self)) {
    ...
    if ('.' == self->symbol) {
      type = Arcadia_DataDefinitionLanguage_WordType_RealLiteral;
      saveAndNext(thread, self);
      while (isDecimalDigit(thread, self)) {
        saveAndNext(thread, self);
      }
