...
#if !defined(ARCADIA_DDL_IMPLEMENTATION_NAMENODE_H_INCLUDED)
#define ARCADIA_DDL_IMPLEMENTATION_NAMENODE_H_INCLUDED
...
#endif // ARCADIA_DDL_IMPLEMENTATION_NAMENODE_H_INCLUDED
