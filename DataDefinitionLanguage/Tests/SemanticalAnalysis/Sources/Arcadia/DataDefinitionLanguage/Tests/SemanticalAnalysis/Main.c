  ...
  )
{
  ...
  if (Arcadia_JumpTarget_save(&jumpTarget)) {
    Arcadia_DataDefinitionLanguage_Tree_Node* node = doSyntacticalAnalysis(thread, parser, text, strlen(text));
...
{
  Arcadia_DataDefinitionLanguage_Parser* syntacticalAnalyser = Arcadia_DataDefinitionLanguage_Parser_create(thread);
