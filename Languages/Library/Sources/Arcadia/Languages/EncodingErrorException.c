...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Languages_EncodingErrorException_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_Languages_EncodingErrorException);
  {
  ...
  Arcadia_LeaveConstructor(Arcadia_Languages_EncodingErrorException);
}
...
{
  _Arcadia_BeginCreate(Arcadia_Languages_EncodingErrorException);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_Languages_EncodingErrorException);
}
