...
#if !defined(ARCADIA_VISUALS_WINDOWS_PNGIMAGEWRITER_H_INCLUDED)
#define ARCADIA_VISUALS_WINDOWS_PNGIMAGEWRITER_H_INCLUDED
...
#endif // ARCADIA_VISUALS_WINDOWS_PNGIMAGEWRITER_H_INCLUDED
