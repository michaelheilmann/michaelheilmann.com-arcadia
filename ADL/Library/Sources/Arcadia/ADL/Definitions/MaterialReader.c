  ...
  )
{
  ...
  Arcadia_ADL_MaterialDefinition* definition = Arcadia_ADL_MaterialDefinition_create(thread, definitions, name, materialType, ambientColorSource, ambientColorTextureName);
  return definition;
}
