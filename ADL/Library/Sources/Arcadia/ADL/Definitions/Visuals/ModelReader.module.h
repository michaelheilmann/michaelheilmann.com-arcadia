...
#if !defined(ARCADIA_ADL_DEFINITIONS_VISUALS_MODELREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_VISUALS_MODELREADER_MODULE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.ADL.ModelReader", Arcadia_ADL_ModelReader,
                          u8"Arcadia.ADL.Reader");

struct Arcadia_ADL_ModelReaderDispatch {
  Arcadia_ADL_ReaderDispatch _parent;
};

struct Arcadia_ADL_ModelReader {
...
#endif  // ARCADIA_ADL_DEFINITIONS_VISUALS_MODELREADER_MODULE_H_INCLUDED
