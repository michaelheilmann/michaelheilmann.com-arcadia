...
#if !defined(ARCADIA_ADL_DEFINITIONS_VISUALS_FILLOPERATIONREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_VISUALS_FILLOPERATIONREADER_MODULE_H_INCLUDED
...
struct Arcadia_ADL_PixelBufferOperations_FillOperationReader {
  ...
  Arcadia_String* NAME;
  // The string `PixelBufferOperations.FillOperation` cached here.
  Arcadia_String* SCHEMANAME;
  // The string `PixelBufferOperations.FillOperation` cached here.
  Arcadia_String* TYPENAME;

  // The string `color` cached.
  Arcadia_String* COLOR;
...
#endif  // ARCADIA_ADL_DEFINITIONS_VISUALS_FILLOPERATIONREADER_MODULE_H_INCLUDED
