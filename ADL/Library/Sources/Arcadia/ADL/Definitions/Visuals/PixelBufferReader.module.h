...
#if !defined(ARCADIA_ADL_DEFINITIONS_VISUALS_PIXELBUFFERREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_VISUALS_PIXELBUFFERREADER_MODULE_H_INCLUDED
...
#endif // ARCADIA_ADL_DEFINITIONS_VISUALS_PIXELBUFFERREADER_MODULE_H_INCLUDED
