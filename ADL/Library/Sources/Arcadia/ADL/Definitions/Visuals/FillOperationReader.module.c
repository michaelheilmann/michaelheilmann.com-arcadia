...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_ADL_PixelBufferOperations_FillOperationReader_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_PixelBufferOperations_FillOperationReader);
  {
  ...
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_PixelBufferOperations_FillOperationReader);
}
...
{
  _Arcadia_BeginCreate(Arcadia_ADL_PixelBufferOperations_FillOperationReader);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_ADL_PixelBufferOperations_FillOperationReader);
}
