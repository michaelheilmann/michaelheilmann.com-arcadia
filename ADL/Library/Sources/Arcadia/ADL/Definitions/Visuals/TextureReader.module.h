...
#if !defined(ARCADIA_ADL_DEFINITIONS_VISUALS_TEXTUREREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_VISUALS_TEXTUREREADER_MODULE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.ADL.TextureReader", Arcadia_ADL_TextureReader,
                          u8"Arcadia.ADL.Reader");

struct Arcadia_ADL_TextureReaderDispatch {
  Arcadia_ADL_ReaderDispatch _parent;
};

struct Arcadia_ADL_TextureReader {
  ...
  Arcadia_String* NAME;
  // The string `Texture` cached here.
...
#endif  // ARCADIA_ADL_DEFINITIONS_VISUALS_TEXTUREREADER_MODULE_H_INCLUDED
