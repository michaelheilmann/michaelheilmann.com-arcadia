...
Arcadia_ADL_AddWhiteNoiseOperationReader_getTypeName
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_AddWhiteNoiseOperationReader* self
  );

static Arcadia_ADL_AddWhiteNoiseOperationDefinition*
Arcadia_ADL_AddWhiteNoiseOperationReader_read
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_AddWhiteNoiseOperationReader* self,
...
static void
Arcadia_ADL_AddWhiteNoiseOperationReader_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_AddWhiteNoiseOperationReader* self
  );
...
static void
Arcadia_ADL_AddWhiteNoiseOperationReader_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_AddWhiteNoiseOperationReaderDispatch* self
  );

static void
Arcadia_ADL_AddWhiteNoiseOperationReader_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_AddWhiteNoiseOperationReader* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*) & Arcadia_ADL_AddWhiteNoiseOperationReader_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*) & Arcadia_ADL_AddWhiteNoiseOperationReader_visitImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.ADL.AddWhiteNoiseOperationReader", Arcadia_ADL_AddWhiteNoiseOperationReader,
  ...
  )
{
  ...
  Arcadia_ADL_AddWhiteNoiseOperationDefinition* definition =
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_AddWhiteNoiseOperationReader);
  {
  ...
  self->SCHEMANAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"AddWhiteNoiseOperation");
  self->TYPENAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"AddWhiteNoiseOperation");
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_AddWhiteNoiseOperationReader);
}
...
{
  ((Arcadia_ADL_ReaderDispatch*)self)->getTypeName = (Arcadia_String * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*)) & Arcadia_ADL_AddWhiteNoiseOperationReader_getTypeName;
  ((Arcadia_ADL_ReaderDispatch*)self)->read = (Arcadia_ADL_Definition * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Context*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_AddWhiteNoiseOperationReader_read;
}
...
Arcadia_ADL_AddWhiteNoiseOperationReader*
Arcadia_ADL_AddWhiteNoiseOperationReader_create
  (
    Arcadia_Thread* thread
  )
{
  ...
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  ARCADIA_CREATEOBJECT(Arcadia_ADL_AddWhiteNoiseOperationReader);
}
