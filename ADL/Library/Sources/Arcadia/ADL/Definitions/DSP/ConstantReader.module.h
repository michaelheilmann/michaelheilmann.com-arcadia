...
#if !defined(ARCADIA_ADL_DEFINITIONS_DSP_CONSTANTREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_DSP_CONSTANTREADER_MODULE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.ADL.ConstantReader", Arcadia_ADL_ConstantReader,
                          u8"Arcadia.ADL.Reader");

struct Arcadia_ADL_ConstantReaderDispatch {
  Arcadia_ADL_ReaderDispatch _parent;
};

struct Arcadia_ADL_ConstantReader {
  ...
  Arcadia_String* NAME;
  // The string `DSP.Constant` cached here.
  Arcadia_String* SCHEMANAME;
  // The string `DSP.Constant` cached here.
  Arcadia_String* TYPENAME;
  // The string `value` cached here.
...
#endif  // ARCADIA_ADL_DEFINITIONS_DSP_CONSTANTREADER_MODULE_H_INCLUDED
