...
#if !defined(ARCADIA_ADL_DEFINITIONS_DSP_SINEWAVEREADER_MODULE_H_INCLUDED)
#define ARCADIA_ADL_DEFINITIONS_DSP_SINEWAVEREADER_MODULE_H_INCLUDED
...
Arcadia_declareObjectType(u8"Arcadia.ADL.SineWaveReader", Arcadia_ADL_SineWaveReader,
                          u8"Arcadia.ADL.Reader");

struct Arcadia_ADL_SineWaveReaderDispatch {
  Arcadia_ADL_ReaderDispatch _parent;
};

struct Arcadia_ADL_SineWaveReader {
  ...
  Arcadia_String* NAME;
  // The string `DSP.SineWaveGenerator` cached here.
...
#endif  // ARCADIA_ADL_DEFINITIONS_DSP_SINEWAVEREADER_MODULE_H_INCLUDED
