...
Arcadia_ADL_SawtoothWaveReader_getTypeName
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SawtoothWaveReader* self
  );

static Arcadia_ADL_SawtoothWaveDefinition*
Arcadia_ADL_SawtoothWaveReader_read
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SawtoothWaveReader* self,
...
static void
Arcadia_ADL_SawtoothWaveReader_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SawtoothWaveReader* self
  );
...
static void
Arcadia_ADL_SawtoothWaveReader_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SawtoothWaveReaderDispatch* self
  );

static void
Arcadia_ADL_SawtoothWaveReader_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SawtoothWaveReader* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_ADL_SawtoothWaveReader_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_ADL_SawtoothWaveReader_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_ADL_SawtoothWaveReader_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.ADL.SawtoothWaveReader", Arcadia_ADL_SawtoothWaveReader,
  ...
  )
{
  ...
  Arcadia_Integer32Value frequency = Arcadia_ADL_Reader_getInteger32Value(thread, (Arcadia_DDL_MapNode*)input, self->FREQUENCY);
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_SawtoothWaveReader);
  {
  ...
  self->SCHEMANAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.SawtoothWave");
  self->TYPENAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.SawtoothWave");
  //
  ...
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_SawtoothWaveReader);
}
...
{
  ((Arcadia_ADL_ReaderDispatch*)self)->getTypeName = (Arcadia_String * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*)) & Arcadia_ADL_SawtoothWaveReader_getTypeName;
  ((Arcadia_ADL_ReaderDispatch*)self)->read = (Arcadia_ADL_Definition * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Context*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_SawtoothWaveReader_read;
}
...
{
  _Arcadia_BeginCreate(Arcadia_ADL_SawtoothWaveReader);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_ADL_SawtoothWaveReader);
}
