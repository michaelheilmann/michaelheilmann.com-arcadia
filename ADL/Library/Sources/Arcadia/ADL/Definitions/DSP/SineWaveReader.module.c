...
Arcadia_ADL_SineWaveReader_getTypeName
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SineWaveReader* self
  );

static Arcadia_ADL_SineWaveDefinition*
Arcadia_ADL_SineWaveReader_read
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SineWaveReader* self,
...
static void
Arcadia_ADL_SineWaveReader_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SineWaveReader* self
  );
...
static void
Arcadia_ADL_SineWaveReader_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SineWaveReaderDispatch* self
  );

static void
Arcadia_ADL_SineWaveReader_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_SineWaveReader* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_ADL_SineWaveReader_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_ADL_SineWaveReader_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_ADL_SineWaveReader_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.ADL.SineWaveReader", Arcadia_ADL_SineWaveReader,
  ...
  )
{
  ...
  Arcadia_ADL_SineWaveDefinition* definition =
    Arcadia_ADL_SineWaveDefinition_create
      (
        thread,
        definitions,
        name,
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_SineWaveReader);
  {
  ...
  self->SCHEMANAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.SineWave");
  self->TYPENAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.SineWave");
  //
  ...
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_SineWaveReader);
}
...
{
  ((Arcadia_ADL_ReaderDispatch*)self)->getTypeName = (Arcadia_String * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*)) & Arcadia_ADL_SineWaveReader_getTypeName;
  ((Arcadia_ADL_ReaderDispatch*)self)->read = (Arcadia_ADL_Definition * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Context*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_SineWaveReader_read;
}
...
Arcadia_ADL_SineWaveReader*
Arcadia_ADL_SineWaveReader_create
  (
    Arcadia_Thread* thread
  )
{
