...
Arcadia_ADL_ConstantReader_getTypeName
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_ConstantReader* self
  );

static Arcadia_ADL_ConstantDefinition*
Arcadia_ADL_ConstantReader_read
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_ConstantReader* self,
...
static void
Arcadia_ADL_ConstantReader_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_ConstantReader* self
  );
...
static void
Arcadia_ADL_ConstantReader_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_ConstantReaderDispatch* self
  );

static void
Arcadia_ADL_ConstantReader_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_ConstantReader* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_ADL_ConstantReader_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_ADL_ConstantReader_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_ADL_ConstantReader_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.ADL.ConstantReader", Arcadia_ADL_ConstantReader,
  ...
  )
{
  ...
  Arcadia_Real32Value value = Arcadia_ADL_Reader_getReal32Value(thread, (Arcadia_DDL_MapNode*)input, self->VALUE);
  ...
  Arcadia_ADL_ConstantDefinition* definition =
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_ConstantReader);
  {
  ...
  self->SCHEMANAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.Constant");
  self->TYPENAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.Constant");
  self->VALUE = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"value");
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_ConstantReader);
}
...
{
  ((Arcadia_ADL_ReaderDispatch*)self)->getTypeName = (Arcadia_String * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*)) & Arcadia_ADL_ConstantReader_getTypeName;
  ((Arcadia_ADL_ReaderDispatch*)self)->read = (Arcadia_ADL_Definition * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Context*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_ConstantReader_read;
}
...
Arcadia_ADL_ConstantReader*
Arcadia_ADL_ConstantReader_create
  (
    Arcadia_Thread* thread
  )
{
  _Arcadia_BeginCreate(Arcadia_ADL_ConstantReader);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_ADL_ConstantReader);
}
