...
Arcadia_ADL_WhiteNoiseReader_getTypeName
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_WhiteNoiseReader* self
  );

static Arcadia_ADL_WhiteNoiseDefinition*
Arcadia_ADL_WhiteNoiseReader_read
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_WhiteNoiseReader* self,
...
static void
Arcadia_ADL_WhiteNoiseReader_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_WhiteNoiseReader* self
  );
...
static void
Arcadia_ADL_WhiteNoiseReader_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_WhiteNoiseReaderDispatch* self
  );

static void
Arcadia_ADL_WhiteNoiseReader_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_ADL_WhiteNoiseReader* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_ADL_WhiteNoiseReader_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_ADL_WhiteNoiseReader_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_ADL_WhiteNoiseReader_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.ADL.WhiteNoiseReader", Arcadia_ADL_WhiteNoiseReader,
...
{
  Arcadia_EnterConstructor(Arcadia_ADL_WhiteNoiseReader);
  {
  ...
  self->SCHEMANAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.WhiteNoise");
  self->TYPENAME = Arcadia_Languages_StringTable_getOrCreateStringFromCxxString(thread, Arcadia_Languages_StringTable_getOrCreate(thread), u8"DSP.WhiteNoise");
  //
  Arcadia_LeaveConstructor(Arcadia_ADL_WhiteNoiseReader);
}
...
{
  ((Arcadia_ADL_ReaderDispatch*)self)->getTypeName = (Arcadia_String * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*)) & Arcadia_ADL_WhiteNoiseReader_getTypeName;
  ((Arcadia_ADL_ReaderDispatch*)self)->read = (Arcadia_ADL_Definition * (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Context*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_WhiteNoiseReader_read;
}
...
Arcadia_ADL_WhiteNoiseReader*
Arcadia_ADL_WhiteNoiseReader_create
  (
    Arcadia_Thread* thread
  )
{
  _Arcadia_BeginCreate(Arcadia_ADL_WhiteNoiseReader);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_ADL_WhiteNoiseReader);
}
