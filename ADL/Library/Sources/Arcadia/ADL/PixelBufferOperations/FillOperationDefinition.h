...
#if !defined(ARCADIA_ADL_PIXELBUFFEROPERATIONS_FILLOPERATIONDEFINITION_H_INCLUDED)
#define ARCADIA_ADL_PIXELBUFFEROPERATIONS_FILLOPERATIONDEFINITION_H_INCLUDED
...
struct Arcadia_ADL_PixelBufferOperations_FillOperationDefinition {
  ...
  Arcadia_ADL_ColorDefinition* colorDefinition;
