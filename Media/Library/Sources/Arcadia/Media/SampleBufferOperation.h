...
Arcadia_declareObjectType(u8"Arcadia.Media.SampleBufferOperation", Arcadia_Media_SampleBufferOperation,
                          u8"Arcadia.Object");

struct Arcadia_Media_SampleBufferOperationDispatch {
  Arcadia_ObjectDispatch parent;

  void (*apply)(Arcadia_Thread*, Arcadia_Media_SampleBufferOperation*, Arcadia_Media_SampleBuffer*);
};

struct Arcadia_Media_SampleBufferOperation {
