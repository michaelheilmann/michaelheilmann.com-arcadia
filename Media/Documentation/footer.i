  ...
  <div class="right-column">
    <nav>
      <ul style="list-style: none">
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer">Arcadia_Media_PixelBuffer</a></li>
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer_create">Arcadia_Media_PixelBuffer_create</a></li>
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer_getHeight">Arcadia_Media_PixelBuffer_getHeight</a></li>
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer_getLinePadding">Arcadia_Media_PixelBuffer_getLinePadding</a></li>
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer_getNumberOfColumns">Arcadia_Media_PixelBuffer_getNumberOfColumns</a></li>
        <li><a href="@{siteAddress}/Arcadia/Media/#Arcadia_Media_PixelBuffer_getNumberOfRows">Arcadia_Media_PixelBuffer_getNumberOfRows</a></li>
