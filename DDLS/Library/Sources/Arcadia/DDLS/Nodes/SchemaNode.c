...
static void
Arcadia_DDLS_SchemaNode_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_DDLS_SchemaNodeDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_DDLS_SchemaNode_objectTypeOperations = {
  ...
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_DDLS_SchemaNode_initializeDispatchImpl,
};
