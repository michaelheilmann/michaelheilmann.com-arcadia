...
static const Arcadia_ObjectType_Operations _Arcadia_DDLS_SchemaReferenceSymbol_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_DDLS_SchemaReferenceSymbol_constructImpl,
...
{
  Arcadia_TypeValue _type = _Arcadia_DDLS_SchemaReferenceSymbol_getType(thread);
  //
  {
  ...
  )
{
  ...
  ARCADIA_CREATEOBJECT(Arcadia_DDLS_SchemaReferenceSymbol);
}
