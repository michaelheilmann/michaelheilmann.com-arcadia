...
#if !defined(ARCADIA_DDLS_SEMANTICAL_SCHEMASYMBOL_H_INCLUDED)
#define ARCADIA_DDLS_SEMANTICAL_SCHEMASYMBOL_H_INCLUDED
...
#endif // ARCADIA_DDLS_SEMANTICAL_SCHEMASYMBOL_H_INCLUDED
