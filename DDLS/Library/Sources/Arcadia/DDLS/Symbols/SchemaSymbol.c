...
static void
Arcadia_DDLS_SchemaSymbol_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_DDLS_SchemaSymbolDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_DDLS_SchemaSymbol_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_DDLS_SchemaSymbol_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_DDLS_SchemaSymbol_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_DDLS_SchemaSymbol_initializeDispatchImpl,
};
...
{
  _Arcadia_BeginCreate(Arcadia_DDLS_SchemaSymbol);
  if (name) {
  ...
  Arcadia_ValueStack_pushNatural8Value(thread, 1);
  _Arcadia_EndCreate(Arcadia_DDLS_SchemaSymbol);
}
