...
static void
Arcadia_DDLS_MapSymbol_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_DDLS_MapSymbolDispatch* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_DDLS_MapSymbol_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_DDLS_MapSymbol_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_DDLS_MapSymbol_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_DDLS_MapSymbol_initializeDispatchImpl,
};
...
{
  Arcadia_EnterConstructor(Arcadia_DDLS_MapSymbol);
  //
  {
  ...
  //
  Arcadia_LeaveConstructor(Arcadia_DDLS_MapSymbol);
}
...
{
  _Arcadia_BeginCreate(Arcadia_DDLS_MapSymbol);
  Arcadia_ValueStack_pushNatural8Value(thread, 0);
  _Arcadia_EndCreate(Arcadia_DDLS_MapSymbol);
}
