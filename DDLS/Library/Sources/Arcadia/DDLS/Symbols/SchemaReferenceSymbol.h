...
#if !defined(ARCADIA_DDLS_SYMBOLS_SCHEMAREFERENCESYMBOL_H_INCLUDED)
#define ARCADIA_DDLS_SYMBOLS_SCHEMAREFERENCESYMBOL_H_INCLUDED
...
#endif // ARCADIA_DDLS_SYMBOLS_SCHEMAREFERENCESYMBOL_H_INCLUDED
