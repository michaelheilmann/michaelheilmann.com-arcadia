...
#if !defined(ARCADIA_DDL_IMPLEMENTATION_NODETYPE_H_INCLUDED)
#define ARCADIA_DDL_IMPLEMENTATION_NODETYPE_H_INCLUDED
...
#define Define(Name, Description) \
  ...
  #include "Arcadia/DDL/Implementation/NodeType.i"

#undef Define

};

#endif // ARCADIA_DDL_IMPLEMENTATION_NODETYPE_H_INCLUDED
