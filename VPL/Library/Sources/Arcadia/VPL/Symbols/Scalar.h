...
// Maps to an anonymous uniform block.
#define Arcadia_VPL_ScalarFlags_Constant (1)

// The scalar is a variable.
// Maps to in or out.
#define Arcadia_VPL_ScalarFlags_Variable (2)

// The variable scalar is input to the vertex shader.
// It will be declared as "in" in the vertex shader
#define Arcadia_VPL_ScalarFlags_Vertex (4)
...
#define Arcadia_VPL_ScalarFlags_Fragment (8)
...
#define Arcadia_VPL_ScalarFlags_FrameBuffer (16)

/// @brief Representation of an input/output variable scalar.
Arcadia_declareObjectType(u8"Arcadia.Engine.Visuals.VPL.VariableScalar", Arcadia_VPL_VariableScalar,
                          u8"Arcadia.Object");

struct Arcadia_VPL_VariableScalarDispatch {
  Arcadia_ObjectDispatch _parent;
};

struct Arcadia_VPL_VariableScalar {
