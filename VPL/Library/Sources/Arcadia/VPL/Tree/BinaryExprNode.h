...
#if !defined(ARCADIA_VPL_TREE_BINARYEXPRNODE_H_INCLUDED)
#define ARCADIA_VPL_TREE_BINARYEXPRNODE_H_INCLUDED
...
#define Arcadia_VPL_Tree_BinaryExprNodeFlags_Access (0)

// <expression> '+' <expression>
#define Arcadia_VPL_Tree_BinaryExprNodeFlags_Add (1)

// <expression> '-' <expression>
#define Arcadia_VPL_Tree_BinaryExprNodeFlags_Subtract (2)

// <expression> '*' <expression>
#define Arcadia_VPL_Tree_BinaryExprNodeFlags_Multiply (3)

// <expression> '/' <expression>
#define Arcadia_VPL_Tree_BinaryExprNodeFlags_Divide (4)
...
struct Arcadia_VPL_Tree_BinaryExprNodeDispatch {
...
#endif // ARCADIA_VPL_TREE_BINARYEXPRNODE_H_INCLUDED
